    ...
    t = function(L) {
        ...
        var m,
            ...
            R = function() {
                ...
                return 1 < arguments.length ? (arguments[0] ? (e.prototype = L.extend(new arguments[0], arguments[arguments.length - 1]), e._super = arguments[0].prototype) : e.prototype = arguments[arguments.length - 1], 2 < arguments.length && ((t = Array.prototype.slice.call(arguments, 1, -1)).unshift(e.prototype), L.extend.apply(L, t))) : e.prototype = arguments[0], e.prototype.cls = e
            };
        L.SPFormatClass = m = R({
            fre: /\{\{([\w.]+?)(:(.+?))?\}\}/g,
            precre: /(\w+)\.(\d+)/,
        ...
        p = function(t, e, i, s, r) {
            var n,
                a;
            for (t = (!1 === e ? parseFloat(t).toString() : t.toFixed(e)).split(""), (n = (n = L.inArray(".", t)) < 0 ? t.length : n) < t.length && (t[n] = r), a = n - i; 0 < a; a -= i)
                t.splice(a, 0, s);
            return t.join("")
        },
        b = function(t, e, i) {
        ...
        t = function(t) {
            ...
            i ? S.styleSheets[S.styleSheets.length - 1].cssText = t : e["string" == typeof S.body.style.WebkitAppearance ? "innerText" : "innerHTML"] = t
        },
        L.fn.simpledraw = function(t, e, i, s) {
            var r,
                n;
            if (i && (r = this.data("_jqs_vcanvas")))
                return r;
            if (!1 === L.fn.sparkline.canvas)
                return !1;
            if (L.fn.sparkline.canvas === N) {
                var a = S.createElement("canvas");
                if (a.getContext && a.getContext("2d"))
                    L.fn.sparkline.canvas = function(t, e, i, s) {
                        return new c(t, e, i, s)
                    };
                else {
                    if (!S.namespaces || S.namespaces.v)
                        return L.fn.sparkline.canvas = !1;
                    S.namespaces.add("v", "urn:schemas-microsoft-com:vml", "#default#VML"),
                    L.fn.sparkline.canvas = function(t, e, i, s) {
                        return new d(t, e, i)
                    }
                }
        ...
        L.RangeMapClass = V = R({
            init: function(t) {
                var e,
                    ...
                    s = [];
                for (e in t)
                    t.hasOwnProperty(e) && "string" == typeof e && -1 < e.indexOf(":") && ((i = e.split(":"))[0] = 0 === i[0].length ? -1 / 0 : parseFloat(i[0]), i[1] = 0 === i[1].length ? 1 / 0 : parseFloat(i[1]), i[2] = t[e], s.push(i));
                this.map = t,
                this.rangelist = s || !1
            },
            get: function(t) {
        ...
        u = R({
            ...
            registerCanvas: function(t) {
                var e = L(t.canvas);
                this.canvas = t,
                (this.$canvas = e).mouseenter(L.proxy(this.mouseenter, this)),
                e.mouseleave(L.proxy(this.mouseleave, this)),
                e.click(L.proxy(this.mouseclick, this))
            },
            reset: function(t) {
                this.splist = [],
                this.tooltip && t && (this.tooltip.remove(), this.tooltip = N)
            },
            ...
            mouseenter: function(t) {
                ...
                L(S.body).bind("mousemove.jqs", L.proxy(this.mousemove, this)),
                this.over = !0,
                this.currentPageX = t.pageX,
                this.currentPageY = t.pageY,
                this.currentEl = t.target,
                !this.tooltip && this.displayTooltips && (this.tooltip = new e(this.options), this.tooltip.updatePosition(t.pageX, t.pageY)),
                this.updateDisplay()
            },
            mouseleave: function() {
                L(S.body).unbind("mousemove.jqs");
                var t,
                    ...
                    i = e.length,
                    s = !1;
                for (this.over = !1, this.currentEl = null, this.tooltip && (this.tooltip.remove(), this.tooltip = null), t = 0; t < i; t++)
        ...
        e = R({
            ...
            setContent: function(t) {
                if (!t)
                    return this.tooltip.css("visibility", "hidden"), void (this.hidden = !0);
                this.getSize(t),
        ...
        f = [],
        L.fn.sparkline = function(l, i) {
            return this.each(function() {
                var t,
                    h = new L.fn.sparkline.options(this, i),
                    o = L(this),
                    e = function() {
                        var t,
                            e,
                            ...
                            s,
                            r,
                            n = "html" === l || l === N ? ((r = this.getAttribute(h.get("tagValuesAttribute"))) !== N && null !== r || (r = o.html()), r.replace(/(^\s*<!--)|(-->\s*$)|\s+/g, "").split(",")) : l,
                            a = "auto" === h.get("width") ? n.length * h.get("defaultPixelsPerValue") : h.get("width");
                        "auto" === h.get("height") ? h.get("composite") && L.data(this, "_jqs_vcanvas") || ((e = S.createElement("span")).innerHTML = "a", o.html(e), t = L(e).innerHeight() || L(e).height(), L(e).remove(), e = null) : t = h.get("height"),
                        h.get("disableInteraction") ? i = !1 : (i = L.data(this, "_jqs_mhandler")) ? h.get("composite") || i.reset() : (i = new u(this, h), L.data(this, "_jqs_mhandler", i)),
                        !h.get("composite") || L.data(this, "_jqs_vcanvas") ? ((s = new (L.fn.sparkline[h.get("type")])(this, n, h, a, t)).render(), i && i.registerSparkline(s)) : L.data(this, "_jqs_errnotify") || (alert("Attempted to attach a composite sparkline to an element with no existing sparkline"), L.data(this, "_jqs_errnotify", !0))
                    };
                if (L(this).html() && !h.get("disableHiddenCheck") && L(this).is(":hidden") || !L(this).parents("body").length) {
                    if (!h.get("composite") && L.data(this, "_jqs_pending"))
                        for (t = f.length; t; t--)
                            f[t - 1][0] == this && f.splice(t - 1, 1);
                    f.push([this, e]),
                    L.data(this, "_jqs_pending", !0)
                } else
                    e.call(this)
            })
        },
        L.fn.sparkline.defaults = y(),
        L.sparkline_display_visible = function() {
            for (var t, e = [], i = 0, s = f.length; i < s; i++)
                t = f[i][0],
                L(t).is(":visible") && !L(t).parents().is(":hidden") ? (f[i][1].call(t), L.data(f[i][0], "_jqs_pending", !1), e.push(i)) : L(t).closest("html").length || L.data(t, "_jqs_pending") || (L.data(f[i][0], "_jqs_pending", !1), e.push(i));
            for (i = e.length; i; i--)
                f.splice(e[i - 1], 1)
        },
        L.fn.sparkline.options = R({
            init: function(t, e) {
                var i,
                    s,
                    r,
                ...
                this.tag = t,
                this.tagValCache = {},
                r = (s = L.fn.sparkline.defaults).common,
                this.tagOptionsPrefix = e.enableTagOptions && (e.tagOptionsPrefix || r.tagOptionsPrefix),
                i = (n = this.getTagSetting("type")) === v ? s[e.type || r.type] : s[n],
                this.mergedOptions = L.extend({}, r, i, e)
            },
            getTagSetting: function(t) {
                ...
                if (this.tagValCache.hasOwnProperty(t))
                    ...
                    if ((e = this.tag.getAttribute(n + t)) === N || null === e)
                        e = v;
                    else if ("[" === e.substr(0, 1))
                        for (i = (e = e.substr(1, e.length - 2).split(",")).length; i--;)
                            e[i] = F(e[i].replace(/(^\s*)|(\s*$)/g, ""));
                    else if ("{" === e.substr(0, 1))
                        for (s = e.substr(1, e.length - 2).split(","), e = {}, i = s.length; i--;)
                            e[(r = s[i].split(":", 2))[0].replace(/(^\s*)|(\s*$)/g, "")] = F(r[1].replace(/(^\s*)|(\s*$)/g, ""));
                    else
                        e = F(e);
            ...
            get: function(t, e) {
                ...
                return s !== v ? s : (i = this.mergedOptions[t]) === N ? e : i
            }
        }),
        L.fn.sparkline._base = R({
            disabled: !1,
            ...
            getCurrentRegionTooltip: function() {
                ...
                if (L.isArray(e) || (e = [e]), L.isArray(t) || (t = [t]), a = this.options.get("tooltipFormatFieldlist"), h = this.options.get("tooltipFormatFieldlistKey"), a && h) {
                    for (o = [], n = t.length; n--;)
                        l = t[n][h],
                        -1 != (c = L.inArray(l, a)) && (o[c] = t[n]);
                    t = o
                }
                for (i = e.length, u = t.length, n = 0; n < i; n++)
                    for ("string" == typeof (p = e[n]) && (p = new m(p)), s = p.fclass || "jqsfield", c = 0; c < u; c++)
                        t[c].isNull && d.get("tooltipSkipNull") || (L.extend(t[c], {
            ...
            calcHighlightColor: function(t, e) {
                ...
                if (h && (i = /^#([0-9a-f])([0-9a-f])([0-9a-f])$/i.exec(t) || /^#([0-9a-f]{2})([0-9a-f]{2})([0-9a-f]{2})$/i.exec(t))) {
                    for (r = [], s = 4 === t.length ? 16 : 1, n = 0; n < 3; n++)
                        r[n] = A(z.round(parseInt(i[n + 1], 16) * s * h), 0, 255);
                    return "rgb(" + r.join(",") + ")"
                }
                return t
            }
        ...
        L.fn.sparkline.line = q = R(L.fn.sparkline._base, {
            type: "line",
            init: function(t, e, i, s, r) {
                q._super.init.call(this, t, e, i, s, r),
                this.vertices = [],
                this.regionMap = [],
                this.xvalues = [],
                this.yvalues = [],
            ...
            getRegion: function(t, e, i) {
                for (var s = this.regionMap, r = s.length; r--;)
                    if (null !== s[r] && e >= s[r][0] && e <= s[r][1])
                        return s[r][2];
                return N
            },
            getCurrentRegionFields: function() {
            ...
            scanValues: function() {
                for (var t, e, i, s, r = this.values, n = r.length, a = this.xvalues, h = this.yvalues, o = this.yminmax, l = 0; l < n; l++)
                    t = r[l],
                    e = "string" == typeof r[l],
                    i = "object" == typeof r[l] && r[l] instanceof Array,
                    s = e && r[l].split(":"),
                    e && 2 === s.length ? (a.push(Number(s[0])), h.push(Number(s[1])), o.push(Number(s[1]))) : i ? (a.push(t[0]), h.push(t[1]), o.push(t[1])) : (a.push(l), null === r[l] || "null" === r[l] ? h.push(null) : (h.push(Number(t)), o.push(Number(t))));
                this.options.get("xvalues") && (a = this.options.get("xvalues")),
                this.maxy = this.maxyorg = z.max.apply(z, o),
                this.miny = this.minyorg = z.min.apply(z, o),
                this.maxx = z.max.apply(z, a),
                this.minx = z.min.apply(z, a),
                this.xvalues = a,
                this.yvalues = h,
                this.yminmax = o
            },
            ...
            render: function() {
                ...
                if (q._super.render.call(this) && (this.scanValues(), this.processRangeOptions(), w = this.xvalues, b = this.yvalues, this.yminmax.length && !(this.yvalues.length < 2))) {
                    for (s = r = 0, t = this.maxx - this.minx == 0 ? 1 : this.maxx - this.minx, e = this.maxy - this.miny == 0 ? 1 : this.maxy - this.miny, i = this.yvalues.length - 1, W && (M < 4 * W || _ < 4 * W) && (W = 0), W && (((y = S.get("highlightSpotColor") && !S.get("disableInteraction")) || S.get("minSpotColor") || S.get("spotColor") && b[i] === this.miny) && (_ -= z.ceil(W)), (y || S.get("maxSpotColor") || S.get("spotColor") && b[i] === this.maxy) && (_ -= z.ceil(W), s += z.ceil(W)), !y && (!S.get("minSpotColor") && !S.get("maxSpotColor") || b[0] !== this.miny && b[0] !== this.maxy) || (r += z.ceil(W), M -= z.ceil(W)), (y || S.get("spotColor") || S.get("minSpotColor") || S.get("maxSpotColor") && (b[i] === this.miny || b[i] === this.maxy)) && (M -= z.ceil(W))), _--, S.get("normalRangeMin") === N || S.get("drawNormalOnTop") || this.drawNormalRange(r, s, _, M, e), h = [a = []], u = null, d = b.length, R = 0; R < d; R++)
                        o = w[R],
                        g = w[R + 1],
                        l = b[R],
                        c = (p = r + z.round((o - this.minx) * (M / t))) + ((R < d - 1 ? r + z.round((g - this.minx) * (M / t)) : M) - p) / 2,
                        T[R] = [u || 0, c, R],
                        u = c,
                        null === l ? R && (null !== b[R - 1] && (a = [], h.push(a)), H.push(null)) : (l < this.miny && (l = this.miny), l > this.maxy && (l = this.maxy), a.length || a.push([p, s + _]), n = [p, s + z.round(_ - _ * ((l - this.miny) / e))], a.push(n), H.push(n));
                    for (f = [], v = [], m = h.length, R = 0; R < m; R++)
                        (a = h[R]).length && (S.get("fillColor") && (a.push([a[a.length - 1][0], s + _]), v.push(a.slice(0)), a.pop()), 2 < a.length && (a[0] = [a[0][0], a[1][1]]), f.push(a));
                    for (m = v.length, R = 0; R < m; R++)
                        k.drawShape(v[R], S.get("fillColor"), S.get("fillColor")).append();
                    for (S.get("normalRangeMin") !== N && S.get("drawNormalOnTop") && this.drawNormalRange(r, s, _, M, e), m = f.length, R = 0; R < m; R++)
                        k.drawShape(f[R], S.get("lineColor"), N, S.get("lineWidth")).append();
                    if (W && S.get("valueSpots"))
                        for ((x = S.get("valueSpots")).get === N && (x = new V(x)), R = 0; R < d; R++)
                            (C = x.get(b[R])) && k.drawCircle(r + z.round((w[R] - this.minx) * (M / t)), s + z.round(_ - _ * ((b[R] - this.miny) / e)), W, N, C).append();
                    W && S.get("spotColor") && null !== b[i] && k.drawCircle(r + z.round((w[w.length - 1] - this.minx) * (M / t)), s + z.round(_ - _ * ((b[i] - this.miny) / e)), W, N, S.get("spotColor")).append(),
                    this.maxy !== this.minyorg && (W && S.get("minSpotColor") && (o = w[L.inArray(this.minyorg, b)], k.drawCircle(r + z.round((o - this.minx) * (M / t)), s + z.round(_ - _ * ((this.minyorg - this.miny) / e)), W, N, S.get("minSpotColor")).append()), W && S.get("maxSpotColor") && (o = w[L.inArray(this.maxyorg, b)], k.drawCircle(r + z.round((o - this.minx) * (M / t)), s + z.round(_ - _ * ((this.maxyorg - this.miny) / e)), W, N, S.get("maxSpotColor")).append())),
                    this.lastShapeId = k.getLastShapeId(),
                    this.canvasTop = s,
                    k.render()
                }
            }
        }),
        L.fn.sparkline.bar = X = R(L.fn.sparkline._base, i, {
            type: "bar",
            init: function(t, e, i, s, r) {
                var n,
                    a,
                    ...
                    b,
                    R,
                    S = parseInt(i.get("barWidth"), 10),
                    k = parseInt(i.get("barSpacing"), 10),
                    M = i.get("chartRangeMin"),
                    _ = i.get("chartRangeMax"),
                    H = i.get("chartRangeClip"),
                    W = 1 / 0,
                    T = -1 / 0;
                for (X._super.init.call(this, t, e, i, s, r), j = 0, P = e.length; j < P; j++)
                    ((n = "string" == typeof (b = e[j]) && -1 < b.indexOf(":")) || L.isArray(b)) && (m = !0, n && (b = e[j] = B(b.split(":"))), b = O(b, null), (a = z.min.apply(z, b)) < W && (W = a), T < (h = z.max.apply(z, b)) && (T = h));
                this.stacked = m,
                this.regionShapes = {},
                this.barWidth = S,
                this.barSpacing = k,
                this.totalBarWidth = S + k,
                this.width = s = e.length * S + (e.length - 1) * k,
                this.initTarget(),
                H && (f = M === N ? -1 / 0 : M, v = _ === N ? 1 / 0 : _),
                l = [],
                o = m ? [] : l;
                for (var q = [], I = [], j = 0, P = e.length; j < P; j++)
                    if (m)
                        for (x = e[j], e[j] = w = [], q[j] = 0, y = o[j] = I[j] = 0, C = x.length; y < C; y++)
                            null !== (b = w[y] = H ? A(x[y], f, v) : x[y]) && (0 < b && (q[j] += b), W < 0 && 0 < T ? b < 0 ? I[j] += z.abs(b) : o[j] += b : o[j] += z.abs(b - (b < 0 ? T : W)), l.push(b));
                    else
                        b = H ? A(e[j], f, v) : e[j],
                        null !== (b = e[j] = F(b)) && l.push(b);
                this.max = d = z.max.apply(z, l),
                this.min = c = z.min.apply(z, l),
                this.stackMax = T = m ? z.max.apply(z, q) : d,
                this.stackMin = W = m ? z.min.apply(z, l) : c,
                i.get("chartRangeMin") !== N && (i.get("chartRangeClip") || i.get("chartRangeMin") < c) && (c = i.get("chartRangeMin")),
                i.get("chartRangeMax") !== N && (i.get("chartRangeClip") || i.get("chartRangeMax") > d) && (d = i.get("chartRangeMax")),
                this.zeroAxis = p = i.get("zeroAxis", !0),
                u = c <= 0 && 0 <= d && p ? 0 : 0 == p || 0 < c ? c : d,
                this.xaxisOffset = u,
                g = m ? z.max.apply(z, o) + z.max.apply(z, I) : d - c,
                this.canvasHeightEf = p && c < 0 ? this.canvasHeight - 2 : this.canvasHeight - 1,
                c < u ? (R = ((m && 0 <= d ? T : d) - u) / g * this.canvasHeight) !== z.ceil(R) && (this.canvasHeightEf -= 2, R = z.ceil(R)) : R = this.canvasHeight,
                this.yoffset = R,
                L.isArray(i.get("colorMap")) ? (this.colorMapByIndex = i.get("colorMap"), this.colorMapByValue = null) : (this.colorMapByIndex = null, this.colorMapByValue = i.get("colorMap"), this.colorMapByValue && this.colorMapByValue.get === N && (this.colorMapByValue = new V(this.colorMapByValue))),
                this.range = g
            },
            getRegion: function(t, e, i) {
            ...
            getCurrentRegionFields: function() {
                for (var t, e = this.currentRegion, i = n(this.values[e]), s = [], r = i.length; r--;)
                    t = i[r],
                    s.push({
                        isNull: null === t,
                        value: t,
                        color: this.calcColor(r, t, e),
                        offset: e
                    });
                return s
            },
            calcColor: function(t, e, i) {
                var s,
                    ...
                    a = this.options,
                    h = this.stacked ? a.get("stackedBarColor") : e < 0 ? a.get("negBarColor") : a.get("barColor");
                return 0 === e && a.get("zeroColor") !== N && (h = a.get("zeroColor")), n && (s = n.get(e)) ? h = s : r && r.length > i && (h = r[i]), L.isArray(h) ? h[t % h.length] : h
            },
            renderRegion: function(t, e) {
                var i,
                    ...
                    w = b(g, o, !0);
                if (C)
                    return l.get("nullColor") ? (r = e ? l.get("nullColor") : this.calcHighlightColor(l.get("nullColor"), l), i = 0 < m ? m - 1 : m, d.drawRect(f, i, this.barWidth - 1, 0, r, r)) : N;
                for (n = m, a = 0; a < x; a++) {
                    if (y = o[a], c && y === g) {
                        if (!w || h)
                            continue;
                    ...
                    s = 0 < u ? z.floor(v * (z.abs(y - g) / u)) + 1 : 1,
                    y < g || y === g && 0 === m ? (i = n, n += s) : (i = m - s, m -= s),
                    r = this.calcColor(a, y, t),
                    e && (r = this.calcHighlightColor(r, l)),
                    p.push(d.drawRect(f, i, this.barWidth - 1, s - 1, r, r))
                }
                return 1 === p.length ? p[0] : p
            }
        }),
        L.fn.sparkline.tristate = h = R(L.fn.sparkline._base, i, {
            type: "tristate",
            init: function(t, e, i, s, r) {
                var n = parseInt(i.get("barWidth"), 10),
                    a = parseInt(i.get("barSpacing"), 10);
                h._super.init.call(this, t, e, i, s, r),
                this.regionShapes = {},
                this.barWidth = n,
                this.barSpacing = a,
                this.totalBarWidth = n + a,
                this.values = L.map(e, Number),
                this.width = s = e.length * n + (e.length - 1) * a,
                L.isArray(i.get("colorMap")) ? (this.colorMapByIndex = i.get("colorMap"), this.colorMapByValue = null) : (this.colorMapByIndex = null, this.colorMapByValue = i.get("colorMap"), this.colorMapByValue && this.colorMapByValue.get === N && (this.colorMapByValue = new V(this.colorMapByValue))),
                this.initTarget()
            },
            getRegion: function(t, e, i) {
            ...
            calcColor: function(t, e) {
                var i,
                    ...
                    h = a && (i = a.get(t)) ? i : n && n.length > e ? n[e] : s[e] < 0 ? r.get("negBarColor") : 0 < s[e] ? r.get("posBarColor") : r.get("zeroBarColor");
                return h
            },
            renderRegion: function(t, e) {
                var i,
                    ...
                    l = s[t] < 0 ? (i = h) - 1 : 0 < s[t] ? (i = 0, h - 1) : (i = h - 1, 2),
                    g = this.calcColor(s[t], t);
                if (null !== g)
                    return e && (g = this.calcHighlightColor(g, r)), n.drawRect(o, i, this.barWidth - 1, l - 1, g, g)
            }
        }),
        L.fn.sparkline.discrete = a = R(L.fn.sparkline._base, i, {
            type: "discrete",
            init: function(t, e, i, s, r) {
                a._super.init.call(this, t, e, i, s, r),
                this.regionShapes = {},
                this.values = e = L.map(e, Number),
                this.min = z.min.apply(z, e),
                this.max = z.max.apply(z, e),
                this.range = this.max - this.min,
                this.width = s = "auto" === i.get("width") ? 2 * e.length : this.width,
                this.interval = z.floor(s / e.length),
                ...
                this.initTarget(),
                this.target && (this.lineHeight = "auto" === i.get("lineHeight") ? z.round(.3 * this.canvasHeight) : i.get("lineHeight"))
            },
            getRegion: function(t, e, i) {
            ...
            renderRegion: function(t, e) {
                var i = this.values,
                    ...
                    c = t * h,
                    d = z.round(p - (u - r) / a * p),
                    f = s.get("thresholdColor") && u < s.get("thresholdValue") ? s.get("thresholdColor") : s.get("lineColor");
                return e && (f = this.calcHighlightColor(f, s)), o.drawLine(c, d, c, d + g, f)
            }
        }),
        L.fn.sparkline.bullet = o = R(L.fn.sparkline._base, {
            type: "bullet",
            init: function(t, e, i, s, r) {
                var n,
                    a,
                    h;
                o._super.init.call(this, t, e, i, s, r),
                this.values = e = B(e),
                (h = e.slice())[0] = null === h[0] ? h[2] : h[0],
                h[1] = null === e[1] ? h[2] : h[1],
                n = z.min.apply(z, e),
                a = z.max.apply(z, e),
                ...
                this.target = this.$el.simpledraw(s, r, i.get("composite")),
        ...
        L.fn.sparkline.pie = l = R(L.fn.sparkline._base, {
            type: "pie",
            init: function(t, e, i, s, r) {
                var n,
                    a = 0;
                ...
                this.total = a,
                this.initTarget(),
                this.radius = z.floor(z.min(this.canvasWidth, this.canvasHeight) / 2)
            },
            getRegion: function(t, e, i) {
                var s = this.target.getShapeAt(t, e, i);
                return s !== N && this.shapes[s] !== N ? this.shapes[s] : N
            ...
            renderSlice: function(t, e) {
                for (var i, s, r, n = this.target, a = this.options, h = this.radius, o = a.get("borderWidth"), l = a.get("offset"), g = 2 * z.PI, p = this.values, u = this.total, c = l ? 2 * z.PI * (l / 360) : 0, d = p.length, f = 0; f < d; f++) {
                    if (s = i = c, 0 < u && (s = c + g * (p[f] / u)), t === f)
                        return r = a.get("sliceColors")[f % a.get("sliceColors").length], e && (r = this.calcHighlightColor(r, a)), n.drawPieSlice(h, h, h - o, i, s, N, r);
                    c = s
                }
            },
            render: function() {
                ...
                if (l._super.render.call(this)) {
                    for (a && i.drawCircle(n, n, z.floor(n - a / 2), r.get("borderColor"), N, a).append(), e = s.length; e--;)
                        s[e] && (t = this.renderSlice(e).append(), this.valueShapes[e] = t.id, this.shapes[t.id] = e);
                    h && i.drawCircle(n, n, n - h, r.get("donutColor"), r.get("donutColor"), 0).append(),
                    i.render()
                }
            }
        }),
        L.fn.sparkline.box = w = R(L.fn.sparkline._base, {
            type: "box",
            init: function(t, e, i, s, r) {
                w._super.init.call(this, t, e, i, s, r),
                this.values = L.map(e, Number),
            ...
            render: function() {
                ...
                if (w._super.render.call(this)) {
                    if (d.get("raw"))
                        d.get("showOutliers") && 5 < u.length ? (e = u[0], t = u[1], s = u[2], r = u[3], n = u[4], a = u[5], h = u[6]) : (t = u[0], s = u[1], r = u[2], n = u[3], a = u[4]);
                    else if (u.sort(function(t, e) {
                        return t - e
                    }), s = C(u, 1), r = C(u, 2), i = (n = C(u, 3)) - s, d.get("showOutliers")) {
                        for (t = a = N, o = 0; o < c; o++)
                            t === N && u[o] > s - i * d.get("outlierIQR") && (t = u[o]),
                            u[o] < n + i * d.get("outlierIQR") && (a = u[o]);
                        e = u[0],
                        h = u[c - 1]
                    } else
                        t = u[0],
                        a = u[c - 1];
                    this.quartiles = [s, r, n],
                    this.lwhisker = t,
                    this.rwhisker = a,
                    this.loutlier = e,
                    this.routlier = h,
                    g = f / (x - m + 1),
                    d.get("showOutliers") && (y = z.ceil(d.get("spotRadius")), g = (f -= 2 * z.ceil(d.get("spotRadius"))) / (x - m + 1), e < t && p.drawCircle((e - m) * g + y, v / 2, d.get("spotRadius"), d.get("outlierLineColor"), d.get("outlierFillColor")).append(), a < h && p.drawCircle((h - m) * g + y, v / 2, d.get("spotRadius"), d.get("outlierLineColor"), d.get("outlierFillColor")).append()),
                    p.drawRect(z.round((s - m) * g + y), z.round(.1 * v), z.round((n - s) * g), z.round(.8 * v), d.get("boxLineColor"), d.get("boxFillColor")).append(),
                    p.drawLine(z.round((t - m) * g + y), z.round(v / 2), z.round((s - m) * g + y), z.round(v / 2), d.get("lineColor")).append(),
                    p.drawLine(z.round((t - m) * g + y), z.round(v / 4), z.round((t - m) * g + y), z.round(v - v / 4), d.get("whiskerColor")).append(),
                    p.drawLine(z.round((a - m) * g + y), z.round(v / 2), z.round((n - m) * g + y), z.round(v / 2), d.get("lineColor")).append(),
                    p.drawLine(z.round((a - m) * g + y), z.round(v / 4), z.round((a - m) * g + y), z.round(v - v / 4), d.get("whiskerColor")).append(),
                    p.drawLine(z.round((r - m) * g + y), z.round(.1 * v), z.round((r - m) * g + y), z.round(.9 * v), d.get("medianColor")).append(),
                    d.get("target") && (l = z.ceil(d.get("spotRadius")), p.drawLine(z.round((d.get("target") - m) * g + y), z.round(v / 2 - l), z.round((d.get("target") - m) * g + y), z.round(v / 2 + l), d.get("targetColor")).append(), p.drawLine(z.round((d.get("target") - m) * g + y - l), z.round(v / 2), z.round((d.get("target") - m) * g + y + l), z.round(v / 2), d.get("targetColor")).append()),
                    p.render()
                }
            }
        }),
        ...
        r = R({
            ...
            _calculatePixelDims: function(t, e, i) {
                var s = this._pxregex.exec(e);
                this.pixelHeight = s ? s[1] : L(i).height(),
                s = this._pxregex.exec(t),
                this.pixelWidth = s ? s[1] : L(i).width()
            },
        ...
        c = R(r, {
            ...
            _drawShape: function(t, e, i, s, r) {
                var n,
                    a,
                    h = this._getContext(i, s, r);
                for (h.beginPath(), h.moveTo(e[0][0] + .5, e[0][1] + .5), n = 1, a = e.length; n < a; n++)
                    h.lineTo(e[n][0] + .5, e[n][1] + .5);
                i !== N && h.stroke(),
                s !== N && h.fill(),
                this.targetX !== N && this.targetY !== N && h.isPointInPath(this.targetX, this.targetY) && (this.currentTargetShapeId = t)
            },
            _drawCircle: function(t, e, i, s, r, n, a) {
                var h = this._getContext(r, n, a);
                h.beginPath(),
                h.arc(e, i, s, 0, 2 * z.PI, !1),
                this.targetX !== N && this.targetY !== N && h.isPointInPath(this.targetX, this.targetY) && (this.currentTargetShapeId = t),
                r !== N && h.stroke(),
                n !== N && h.fill()
            },
            _drawPieSlice: function(t, e, i, s, r, n, a, h) {
                ...
                a !== N && o.stroke(),
                h && o.fill(),
                this.targetX !== N && this.targetY !== N && o.isPointInPath(this.targetX, this.targetY) && (this.currentTargetShapeId = t)
            },
            ...
            replaceWithShapes: function(t, e) {
                for (var i, s, r = this.shapeseq, n = {}, a = t.length; a--;)
                    n[t[a]] = !0;
                for (a = r.length; a--;)
                    n[i = r[a]] && (r.splice(a, 1), delete this.shapes[i], s = a);
                for (a = e.length; a--;)
                    r.splice(s, 0, e[a].id),
            ...
            render: function() {
                var t,
                    ...
                    s = this.shapes,
                    r = i.length;
                for (this._getContext().clearRect(0, 0, this.pixelWidth, this.pixelHeight), e = 0; e < r; e++)
        ...
        d = R(r, {
            ...
            replaceWithShapes: function(t, e) {
                for (var i = L("#jqsshape" + t[0]), s = "", r = e.length, n = 0; n < r; n++)
                    s += this["_draw" + e[n].type].apply(this, e[n].args);
                for (i[0].outerHTML = s, n = 1; n < t.length; n++)
                    L("#jqsshape" + t[n]).remove()
            },
            insertAfterShape: function(t, e) {
                var i = L("#jqsshape" + t),
                    s = this["_draw" + e.type].apply(this, e.args);
