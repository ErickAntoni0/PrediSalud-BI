!function(e, t) {
    ...
    function b(e, t) {
        ...
        if (e !== a && t !== a || o.contains(r))
            return "BODY" === (f = (s = a).nodeName) || "HTML" !== f && w(s.firstElementChild) !== s ? w(a) : a;
        var p = l(e);
    ...
    function d(n, o) {
        Object.keys(o).forEach(function(e) {
            var t = "";
            -1 !== ["width", "height", "top", "right", "bottom", "left"].indexOf(e) && p(o[e]) && (t = "px"),
            n.style[e] = o[e] + t
        })
    }
    function A(e, t) {
            ...
            return e.reduce(function(e, t) {
                ...
                return function(e, t, n, o) {
                    ...
                    if (!s)
                        return e;
                    if (0 !== f.indexOf("%"))
                        return "vh" !== f && "vw" !== f ? s : ("vh" === f ? R(document.documentElement.clientHeight, window.innerHeight || 0) : R(document.documentElement.clientWidth, window.innerWidth || 0)) / 100 * s;
                    switch (f) {
                    case "%p":
                        r = n;
                        break;
    ...
    function ne(e, t) {
        ...
        Object.keys(X({}, ne.Defaults.modifiers, o.modifiers)).forEach(function(e) {
    ...
    return te.Utils = ("undefined" == typeof window ? global : window).PopperUtils, te.placements = K, te.Defaults = {
        ...
        modifiers: {
            ...
            arrow: {
                ...
                fn: function(e, t) {
                    var n;
                    if (!M(e.instance.modifiers, "arrow", "keepTogether"))
                        return e;
                    var o = t.element;
                    if ("string" == typeof o) {
            ...
            flip: {
                ...
                enabled: !0,
                fn: function(g, v) {
                    if (e(g.instance.modifiers, "inner"))
                        return g;
            ...
            hide: {
                ...
                enabled: !0,
                fn: function(e) {
                    if (!M(e.instance.modifiers, "hide", "preventOverflow"))
                        return e;
