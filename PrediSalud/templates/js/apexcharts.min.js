!function(t, e) {
    ...
    var I = (n(C, [{
            ...
            value: function() {
                ...
                for (var i = (i = t.replace("#", "")).match(new RegExp("(.{" + i.length / 3 + "})", "g")), a = 0; a < i.length; a++)
        ...
        E = (n(S, [{
            ...
            value: function(i) {
                !function(t) {
                    for (var e in t)
                        t.hasOwnProperty(e) && i.setAttribute(e, t[e])
                }({
                    width: "200%",
                    height: "200%",
                    x: "-50%",
        ...
        X = (n(k, [{
            ...
            value: function(t, e, i, a, s, r, n, o) {
                ...
                s = s || t.attr("pathFrom"),
                r = r || t.attr("pathTo"),
                (!s || -1 < s.indexOf("undefined") || -1 < s.indexOf("NaN")) && (s = c()),
                (-1 < r.indexOf("undefined") || -1 < r.indexOf("NaN")) && (r = c()),
                ...
                t.plot(s).animate(1, h.globals.easing, o).plot(s).animate(n, h.globals.easing, o).plot(r).afterAll(function() {
                    I.isNumber(i) ? i === h.globals.series[h.globals.maxValsInArrayIndex].length - 2 && h.globals.shouldAnimate && l.animationCompleted(t) : "none" !== a && h.globals.shouldAnimate && (!h.globals.comboCharts && e === h.globals.series.length - 1 || h.globals.comboCharts) && l.animationCompleted(t),
        ...
        Y = (n(w, [{
            ...
            value: function(t) {
                ...
                "none" !== y.config.states.normal.filter.type ? w.getDefaultFilter(z, a) : y.config.chart.dropShadow.enabled && v && (!y.config.chart.dropShadow.enabledOnSeries || y.config.chart.dropShadow.enabledOnSeries && -1 !== y.config.chart.dropShadow.enabledOnSeries.indexOf(a)) && (L = y.config.chart.dropShadow, w.dropShadow(z, L, a)),
                b && (z.node.addEventListener("mouseenter", this.pathMouseEnter.bind(this, z)), z.node.addEventListener("mouseleave", this.pathMouseLeave.bind(this, z)), z.node.addEventListener("mousedown", this.pathMouseDown.bind(this, z))),
                z.attr({
                    pathTo: r,
                    pathFrom: s
                });
            ...
            value: function(t, e, i, a, s) {
                ...
                var p,
                    f,
                    x = !("donut" !== h.config.chart.type && "pie" !== h.config.chart.type && "polarArea" !== h.config.chart.type && "bubble" !== h.config.chart.type),
            ...
            value: function(t, e) {
                ...
                })(a), r(s)), t.node.setAttribute("selected", "true"), d = "true", void 0 === o.globals.selectedDataPoints[h] && (o.globals.selectedDataPoints[h] = []), o.globals.selectedDataPoints[h].push(c)),
                "true" === d ? "none" !== (n = o.config.states.active.filter) && l.applyFilter(t, h, n.type, n.value) : "none" !== o.config.states.active.filter.type && l.getDefaultFilter(t, h),
                "function" == typeof o.config.chart.events.dataPointSelection && o.config.chart.events.dataPointSelection(e, this.ctx, {
        ...
        e = (n(y, [{
            ...
            value: function() {
                function i(t, e, i) {
                    var a,
                        s,
                        r = o.globals.dom.baseEl.querySelector(".apexcharts-".concat(i, "-annotations .apexcharts-").concat(i, "-annotation-label[rel='").concat(e, "']"));
            ...
            value: function(s, r) {
                ...
                return n.globals.series.map(function(t, e) {
                    for (var i = 0, a = 0; a < t.length; a++)
                        n.globals.seriesX[e][a] > s && n.globals.seriesX[e][a] < r && (i += t[a]);
                    return i
                })
            }
        }, {
        ...
        p = (n(f, [{
            ...
            value: function(t, e, i) {
                ...
                var o,
                    l,
                    h = parseFloat(t.y);
                "string" == typeof t.x ? (l = a.globals.labels.indexOf(t.x), a.config.xaxis.convertedCatToNumeric && (l = a.globals.categoryLabels.indexOf(t.x)), s = this.annoCtx.helpers.getStringX(t.x), null === t.y && (h = a.globals.series[t.seriesIndex][l])) : s = (t.x - a.globals.minX) / (a.globals.xRange / a.globals.gridWidth),
                o = a.config.yaxis[t.yAxisIndex].logarithmic ? (h = new P(this.annoCtx.ctx).getLogVal(h, t.yAxisIndex)) / a.globals.yLogRatio[t.yAxisIndex] : (h - a.globals.minYArr[t.yAxisIndex]) / (a.globals.yRange[t.yAxisIndex] / a.globals.gridHeight);
                var c,
                    d,
                    g,
                    u,
    ...
    var t,
        ...
        F = (n(Ne, [{
            ...
            value: function() {
                ...
                if (t.globals.axisCharts) {
                    for (var e = this.yAxisAnnotations.drawYAxisAnnotations(), i = this.xAxisAnnotations.drawXAxisAnnotations(), a = this.pointsAnnotations.drawPointAnnotations(), s = t.config.chart.animations.enabled, r = [e, i, a], n = [i.node, e.node, a.node], o = 0; o < 3; o++)
                        ...
                        !s || t.globals.resized || t.globals.dataChanged || "scatter" !== t.config.chart.type && "bubble" !== t.config.chart.type && 1 < t.globals.dataPoints && n[o].classList.add("apexcharts-element-hidden"),
            ...
            value: function(t, e) {
                ...
                s && (z = this.graphics.drawRect(I.x - v, I.y - C, I.width + v + w, I.height + A + C, p, d || "transparent", 1, g, f, u), T.insertBefore(z.node, P.node))
            }
        }, {
            key: "addShape",
            value: function(t, e) {
                var i = {
                    ...
                    a = this.w;
                -1 < String(i.width).indexOf("%") && (i.width = parseInt(i.width, 10) * parseInt(a.globals.svgWidth, 10) / 100);
                var s = null;
                switch (i.type) {
                case "circle":
                ...
                t.draggable && (this.helpers.makeAnnotationDraggable(s, "shapes", e), s.node.classList.add("apexcharts-resizable-element"))
            }
        }, {
            key: "addImage",
            value: function(t, e) {
                ...
                t.draggable && (this.helpers.makeAnnotationDraggable(p, "images", e), p.node.classList.add("apexcharts-resizable-element"))
            }
        }, {
        ...
        R = (n(He, [{
            ...
            value: function(t, e, i) {
                ...
                var c,
                    d,
                    g,
                    u = void 0 === a.fill.gradient.opacityTo ? e : Array.isArray(a.fill.gradient.opacityTo) ? a.fill.gradient.opacityTo[i] : a.fill.gradient.opacityTo;
            ...
            value: function(t, e, i) {
                ...
                if (h.attr("clip-path", "url(#gridRectMarkerMask".concat(a.globals.cuid, ")")), n.x instanceof Array)
                    for (var c = 0; c < n.x.length; c++) {
                        ...
                        o !== 1 / 0 && (f = a.globals.seriesZ[r][d] / o, (u = a.config.plotOptions.bubble).minBubbleRadius && f < u.minBubbleRadius && (f = u.minBubbleRadius), u.maxBubbleRadius && f > u.maxBubbleRadius && (f = u.maxBubbleRadius)),
        ...
        N = (n(Fe, [{
            ...
            value: function(t, e, i) {
                var a = this,
                    ...
                    h = i,
                    c = null;
                if (!o.enabled || t.x instanceof Array != 1)
                    return c;
                c = n.group({
                ...
                for (var d = 0; d < t.x.length; d++) {
                    var g,
                        ...
                        f = t.x[d] + o.offsetX;
                    l = t.y[d] + o.offsetY + s,
                    isNaN(f) || (1 === i && 0 === d && (h = 0), 1 === i && 1 === d && (h = 1), g = r.globals.series[e][h], u = "", p = function(t) {
                ...
                if ("bubble" !== t.config.chart.type)
                    for (var e = t.globals.dom.baseEl.querySelectorAll(".apexcharts-datalabels text"), i = 0; i < e.length; i++) {
                        var a,
                            ...
                            r = s.getBBox(),
                            n = null;
                        r.width && r.height && (n = this.addBackgroundToDataLabel(s, r)),
                        n && (s.parentNode.insertBefore(n.node, s), a = s.getAttribute("fill"), !t.config.chart.animations.enabled || t.globals.resized || t.globals.dataChanged ? n.attr({
                            fill: a
                        }) : n.animate().attr({
                            fill: a
        ...
        W = (n(Xe, [{
            ...
            value: function(i, a) {
                ...
                function e(t) {
                    for (var e = 0; e < t.length; e++)
                        t[e].index === a && i.node.classList.add("apexcharts-series-collapsed")
                }
            ...
            value: function(t) {
                for (var e = this.w, i = 0; i < t.length; i++)
                    -1 < e.globals.collapsedSeriesIndices.indexOf(i) && (t[i].data = []);
                return t
            }
        }, {
            ...
            value: function() {
                ...
                ["line", "area", "bar", "candlestick", "radar"].forEach(function(t) {
                    for (var e = o.globals.dom.baseEl.querySelectorAll(".apexcharts-".concat(t, "-series .apexcharts-series")), i = 0; i < e.length; i++)
                        !function(t, e, i) {
                            for (var a, s = t[e].childNodes, r = {
                                ...
                                s[n].hasAttribute("pathTo") && (a = s[n].getAttribute("pathTo"), r.paths.push({
                                    d: a
                                }));
                ...
                if (0 < t.length)
                    for (var e = 0; e < t.length; e++) {
                        for (var i = o.globals.dom.baseEl.querySelectorAll(".apexcharts-heatmap .apexcharts-series[data\\:realIndex='".concat(e, "'] rect")), a = [], s = 0; s < i.length; s++)
                            a.push({
            ...
            value: function() {
                ...
                "left" === i.align ? (s = 10, n = "start") : "right" === i.align && (s = e.globals.svgWidth - 10, n = "end"),
                "top" === i.verticalAlign ? r = 50 : "bottom" === i.verticalAlign && (r = e.globals.svgHeight - 50),
                s += i.offsetX,
                r = r + parseInt(i.style.fontSize, 10) + 2 + i.offsetY,
                void 0 !== i.text && "" !== i.text && (t = a.drawText({
                    x: s,
                    y: r,
                    text: i.text,
                    textAnchor: n,
        ...
        V = (n(Me, [{
            ...
            value: function(t) {
                ...
                w.config.series[r].data[s] && w.config.series[r].data[s].strokeColor && (a = w.config.series[r].data[s].strokeColor),
                ...
                S.attr("clip-path", "url(#gridRectMask".concat(w.globals.cuid, ")")),
                void 0 !== g && void 0 !== u && (S.attr("data-range-y1", g), S.attr("data-range-y2", u)),
        ...
        G = (n(Ie, [{
            ...
            value: function(t, e) {
                ...
                var v,
                    ...
                    w = a || !y ? "Z" : 0 < y ? "+" : "-";
                a || (v = (y = Math.abs(y)) % 60, w += l(Math.floor(y / 60)) + ":" + l(v)),
                e = e.replace(/(^|[^\\])K/g, "$1" + w);
        ...
        _ = function() {
            ...
            return n(e, [{
                    ...
                    for (var s = a.group({
                        ...
                        for (var g = this.barHelpers.initialPositions(), o = g.y, u = g.zeroW, n = g.x, d = g.barWidth, p = g.xDivision, f = g.zeroH, x = a.group({
                            ...
                            if (c = g.barHeight, this.isHorizontal) {
                                ...
                                if (void 0 === i.config.series[r].data[b])
                                    break;
                                this.isTimelineBar && i.config.series[r].data[b].x && (c = (C = this.detectOverlappingBars({
                                    ...
                                    yDivision: S,
                                    initPositions: g
                                })).barHeight, k = C.barYPosition),
                                d = (w = this.drawRangeBarPaths(M({
                                    indexes: {
                                        i: r,
                                        j: b,
                                        realIndex: l
                                ...
                                c = (w = this.drawRangeColumnPaths(M({
                                    indexes: {
                                        i: r,
                                        j: b,
                                        realIndex: l
                ...
                value: function(t) {
                    ...
                    s && r && (o = s, l = r, n.config.series[i].data[a].x && (h = n.config.series[i].data[a].x + ":"), "function" == typeof d && (h = d(h, u)));
                    var p,
                        f = "",
                        x = "",
        ...
        U = (n(Te, [{
            ...
            value: function(t) {
                ...
                "histogram" === this.chartType && (i.chart.type = "bar", i = I.extend({
                    plotOptions: {
                        bar: {
                            columnWidth: "99.99%"
                        }
            ...
            value: function(a, t) {
                var s = new z;
                (void 0 === a.yaxis || !a.yaxis || Array.isArray(a.yaxis) && 0 === a.yaxis.length) && (a.yaxis = {}),
                a.yaxis.constructor !== Array && window.Apex.yaxis && window.Apex.yaxis.constructor !== Array && (a.yaxis = I.extend(a.yaxis, window.Apex.yaxis)),
                a.yaxis.constructor !== Array ? a.yaxis = [I.extend(s.yAxis, a.yaxis)] : a.yaxis = I.extendArray(a.yaxis, s.yAxis);
                var e = !1;
                ...
                return t && !r && (r = t.config.series), e && r.length !== a.yaxis.length && r.length && (a.yaxis = r.map(function(t, e) {
                    if (t.name || (r[e].name = "series-".concat(e + 1)), a.yaxis[e])
        ...
        $ = (n(Ce, [{
            ...
            value: function() {
                var t = this.w.config.series.slice(),
                    e = new W(this.ctx);
                if (this.activeSeriesIndex = e.getActiveConfigSeriesIndex(), void 0 !== t[this.activeSeriesIndex].data && 0 < t[this.activeSeriesIndex].data.length && null !== t[this.activeSeriesIndex].data[0] && void 0 !== t[this.activeSeriesIndex].data[0].x && null !== t[this.activeSeriesIndex].data[0])
                    return !0
            }
        }, {
            key: "isFormat2DArray",
            value: function() {
                var t = this.w.config.series.slice(),
                    e = new W(this.ctx);
                if (this.activeSeriesIndex = e.getActiveConfigSeriesIndex(), void 0 !== t[this.activeSeriesIndex].data && 0 < t[this.activeSeriesIndex].data.length && void 0 !== t[this.activeSeriesIndex].data[0] && null !== t[this.activeSeriesIndex].data[0] && t[this.activeSeriesIndex].data[0].constructor === Array)
                    return !0
            }
        }, {
            ...
            value: function(t, e) {
                ...
                for (var s, r = 0; r < t[e].data.length; r++)
                    void 0 !== t[e].data[r][1] && (Array.isArray(t[e].data[r][1]) && 4 === t[e].data[r][1].length ? this.twoDSeries.push(I.parseNumber(t[e].data[r][1][3])) : 5 === t[e].data[r].length ? this.twoDSeries.push(I.parseNumber(t[e].data[r][4])) : this.twoDSeries.push(I.parseNumber(t[e].data[r][1])), a.dataFormatXNumeric = !0),
                    "datetime" === i.xaxis.type ? (s = new Date(t[e].data[r][0]), s = new Date(s).getTime(), this.twoDSeriesX.push(s)) : this.twoDSeriesX.push(t[e].data[r][0]);
            ...
            value: function(t, e) {
                var i = this.w.config,
                    ...
                    s = new G(this.ctx),
                    r = e;
                -1 < a.collapsedSeriesIndices.indexOf(e) && (r = this.activeSeriesIndex),
                i.xaxis.sorted && ("datetime" === i.xaxis.type ? t[e].data.sort(function(t, e) {
                ...
                for (var n = 0; n < t[e].data.length; n++)
                    void 0 !== t[e].data[n].y && (Array.isArray(t[e].data[n].y) ? this.twoDSeries.push(I.parseNumber(t[e].data[n].y[t[e].data[n].y.length - 1])) : this.twoDSeries.push(I.parseNumber(t[e].data[n].y)));
                    ...
                    t && t.forEach(function(n, t) {
                        n.y.forEach(function(t, e) {
                            for (var i, a, s, r = 0; r < n.y.length; r++)
                                e !== r && (i = t.y1, a = t.y2, s = n.y[r].y1, i <= n.y[r].y2 && s <= a && (n.overlaps.indexOf(t.rangeName) < 0 && n.overlaps.push(t.rangeName), n.overlaps.indexOf(n.y[r].rangeName) < 0 && n.overlaps.push(n.y[r].rangeName)))
                        })
                    })
                }), s
            }
            ...
            value: function(t, r, n) {
                ...
                if ("array" === t) {
                    if (2 !== r[i].data[0][1].length)
                        throw new Error(e);
                    for (var a = 0; a < r[n].data.length; a++)
                        o.push(r[n].data[a][1][0]),
                        l.push(r[n].data[a][1][1])
                } else if ("xy" === t) {
                    if (2 !== r[i].data[0].y.length)
                        throw new Error(e);
            ...
            value: function(t) {
                for (var e, i = this, a = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : this.ctx, s = this.w.config, r = this.w.globals, n = new G(a), o = 0 < s.labels.length ? s.labels.slice() : s.xaxis.categories.slice(), l = 0; l < t.length; l++) {
                    ...
                    "rangeBar" !== s.chart.type && "rangeArea" !== s.chart.type && "rangeBar" !== t[l].type && "rangeArea" !== t[l].type || (r.isRangeData = !0, this.handleRangeData(t, l)),
                    ...
                    void 0 !== t[l].name ? r.seriesNames.push(t[l].name) : r.seriesNames.push("series-" + parseInt(l + 1, 10))
                }
                return this.w
            }
        }, {
            ...
            value: function(t) {
                ...
                "bar" === a.chart.type && a.chart.stacked && (e = new W(this.ctx), s.series = e.setNullSeriesToZeroValues(s.series)),
                this.coreUtils.getSeriesTotals(),
                s.axisCharts && this.coreUtils.getStackedSeriesTotals(),
                this.coreUtils.getPercentSeries(),
                s.dataFormatXNumeric || s.isXNumeric && ("numeric" !== a.xaxis.type || 0 !== a.labels.length || 0 !== a.xaxis.categories.length) || this.handleExternalLabelsData(t);
        ...
        Q = (n(Ae, [{
            ...
            value: function(t, e, i, a) {
                ...
                0 < e.length ? (s = e[a].unit, r = null, e.forEach(function(t) {
                    "month" === t.unit ? r = "year" : "day" === t.unit ? r = "month" : "hour" === t.unit ? r = "day" : "minute" === t.unit && (r = "hour")
                }), u = r === s, i = e[a].position, c = e[a].value) : "datetime" === l.config.xaxis.type && void 0 === g && (c = ""),
                void 0 === c && (c = ""),
        ...
        K = (n(ke, [{
            ...
            value: function(t) {
                ...
                g.globals.axisCharts || (u.push(g.config.chart.toolbar.export.csv.headerValue), p.push(u.join(d))),
                c.map(function(t, e) {
                    g.globals.axisCharts ? function(t, e) {
                        if (u.length && 0 === e && p.push(u.join(d)), t.data && t.data.length)
                            for (var i = 0; i < t.data.length; i++) {
                                ...
                                ("candlestick" === g.config.chart.type || t.type && "candlestick" === t.type) && (u.pop(), u.push(g.globals.seriesCandleO[e][i]), u.push(g.globals.seriesCandleH[e][i]), u.push(g.globals.seriesCandleL[e][i]), u.push(g.globals.seriesCandleC[e][i])),
                                "rangeBar" === g.config.chart.type && (u.pop(), u.push(g.globals.seriesRangeStart[e][i]), u.push(g.globals.seriesRangeEnd[e][i])),
                ...
                a += p.join(i),
                this.triggerDownload(encodeURI(a), g.config.chart.toolbar.export.csv.filename, ".csv")
            }
        }, {
            key: "triggerDownload",
            value: function(t, e, i) {
        ...
        tt = (n(we, [{
            ...
            value: function() {
                ...
                t.add(h);
                for (var c = o.globals.padHorizontal, d = [], e = 0; e < this.xaxisLabels.length; e++)
                ...
                if (c = o.globals.isXNumeric ? (i = 1 < p ? p - 1 : p, g = o.globals.gridWidth / i, c + g / 2 + o.config.xaxis.labels.offsetX) : (g = o.globals.gridWidth / d.length, c + g + o.config.xaxis.labels.offsetX), o.config.xaxis.labels.show)
                    for (var f = 0; f <= p - 1; f++)
                        !function(t) {
                            ...
                            (i = n.axesUtils.checkForOverflowingLabels(t, i, p, n.drawnLabels, n.drawnLabelsRects)).text && o.globals.xaxisLabelsCount++;
                            var s = l.drawText({
                                x: i.x,
                            ...
                            "" !== i.text && (n.drawnLabels.push(i.text), n.drawnLabelsRects.push(i)),
                            c += g
                        }(f);
            ...
            value: function(t) {
                ...
                if (u.show)
                    for (var p = 0; p <= l.length - 1; p++) {
                        ...
                        0 !== a.config.yaxis[t].labels.rotate && (m = s.rotateAroundCenter(b.node), b.node.setAttribute("transform", "rotate(".concat(a.config.yaxis[t].labels.rotate, " 0 ").concat(m.y, ")"))),
                        i += e
                    }
            ...
            value: function() {
                ...
                if (a.globals.rotateXLabels || a.config.xaxis.labels.rotateAlways)
                    for (var n = 0; n < r.length; n++) {
                        ...
                        o.y = o.y - 1,
                        o.x = o.x + 1,
                        r[n].setAttribute("transform", "rotate(".concat(a.config.xaxis.labels.rotate, " ").concat(o.x, " ").concat(o.y, ")")),
                ...
                if (0 < e.length) {
                    var h = e[e.length - 1].getBBox(),
                        c = e[0].getBBox();
                    h.x < -20 && e[e.length - 1].parentNode.removeChild(e[e.length - 1]),
                    c.x + c.width > a.globals.gridWidth && !a.globals.isBarHorizontal && e[0].parentNode.removeChild(e[0]);
                    for (var d = 0; d < i.length; d++)
                        s.placeTextWithEllipsis(i[d], i[d].textContent, a.config.yaxis[0].labels.maxWidth - 2 * parseFloat(a.config.yaxis[0].title.style.fontSize) - 20)
                }
            }
        }]), we),
        et = (n(ye, [{
            ...
            value: function() {
                ...
                var r = t.config.chart.type,
                    n = 0,
                    o = 0;
                ("bar" === r || "rangeBar" === r || 0 < t.globals.comboBarCount) && t.globals.isXNumeric && !t.globals.isBarHorizontal && (n = t.config.grid.padding.left, o = t.config.grid.padding.right, i.barPadForNumericAxis > n && (n = i.barPadForNumericAxis, o = i.barPadForNumericAxis)),
                i.dom.elGridRect = a.drawRect(-s / 2 - n - 2, -s / 2, i.gridWidth + s + o + n + 4, i.gridHeight + s, 0, "#fff"),
                new P(this).getLargestMarkerSize();
                var l = t.globals.markers.largestSize + 1;
                i.dom.elGridRectMarker = a.drawRect(2 * -l, 2 * -l, i.gridWidth + 4 * l, i.gridHeight + 4 * l, 0, "#fff"),
            ...
            value: function(t) {
                ...
                if ((h.config.grid.xaxis.lines.show || h.config.xaxis.axisTicks.show) && (e = h.globals.padHorizontal, i = h.globals.gridHeight, h.globals.timescaleLabels.length ? function(t) {
                    for (var e, i, a = t.xC, s = t.y1, r = t.y2, n = 0; n < a; n++)
                    ...
                    for (var e = t.xC, i = t.x1, a = t.y1, s = t.x2, r = t.y2, n = 0; n < e + (h.globals.isXNumeric ? 0 : 1); n++)
                        0 === n && 1 === e && 1 === h.globals.dataPoints && (s = i = h.globals.gridWidth / 2),
                        o._drawGridLines({
                            i: n,
                            x1: i,
                            y1: a,
            ...
            value: function(t, e) {
                ...
                if (void 0 !== i.config.grid.column.colors && 0 < i.config.grid.column.colors.length)
                    for (var l = i.globals.isBarHorizontal || "category" !== i.config.xaxis.type && !i.config.xaxis.convertedCatToNumeric ? t : t - 1, h = i.globals.padHorizontal, c = i.globals.padHorizontal + i.globals.gridWidth / l, d = i.globals.gridHeight, g = 0, u = 0; g < t; g++, u++)
        ...
        it = (n(ve, [{
            ...
            value: function(t, e) {
                var i = 2 < arguments.length && void 0 !== arguments[2] ? arguments[2] : 10,
                    ...
                    r = this.w;
                if ("dataPoints" === i && (i = r.globals.dataPoints - 1), t === Number.MIN_VALUE && 0 === e || !I.isNumber(t) && !I.isNumber(e) || t === Number.MIN_VALUE && e === -Number.MAX_VALUE)
            ...
            value: function(t, s, r, e) {
                ...
                for (var n = Math.log(s) / Math.log(10), o = Math.log(r) / Math.log(10), i = Math.abs(r - s) / e, a = [], l = s; 0 <= e;)
                    a.push(l),
                    l += i,
                    --e;
            ...
            value: function(t, c, d) {
                ...
                if (g.globals.isMultipleYAxis || g.globals.collapsedSeries.length)
                    return console.warn("autoScaleYaxis is not supported in a multi-yaxis chart."), c;
                ...
                return c.forEach(function(a, t) {
                    ...
                    g.globals.series.forEach(function(i, t) {
                        ...
                        (o *= o < 0 ? .9 : 1.1) < 0 && o < l && (o = l),
                        (n *= n < 0 ? 1.1 : .9) < 0 && r < n && (n = r),
                        1 < c.length ? (c[t].min = void 0 === a.min ? n : a.min, c[t].max = void 0 === a.max ? o : a.max) : (c[0].min = void 0 === a.min ? n : a.min, c[0].max = void 0 === a.max ? o : a.max)
                    })
                }), c
            }
        }]), ve),
            ...
            value: function() {
                ...
                if (i.isMultipleYAxis)
                    for (var a = 0; a < i.series.length; a++) {
                        ...
                        i.minYArr.push(s.minY),
                        i.maxYArr.push(s.maxY),
                        t = s.lowestY
                    }
                var r,
                ...
                return i.minY = n.minY, i.maxY = n.maxY, t = n.lowestY, e.chart.stacked && this._setStackedMinMax(), "line" !== e.chart.type && "area" !== e.chart.type && "candlestick" !== e.chart.type && ("rangeBar" !== e.chart.type || i.isBarHorizontal) || i.minY !== Number.MIN_VALUE || t === -Number.MAX_VALUE || t === i.maxY || (r = i.maxY - t, 0 <= t && t <= 10 && (r = 0), i.minY = t - 5 * r / 100, 0 < t && i.minY < 0 && (i.minY = 0), i.maxY = i.maxY + 5 * r / 100), e.yaxis.forEach(function(t, e) {
                    void 0 !== t.max && ("number" == typeof t.max ? i.maxYArr[e] = t.max : "function" == typeof t.max && (i.maxYArr[e] = t.max(i.maxY)), i.maxY = i.maxYArr[e]),
                    void 0 !== t.min && ("number" == typeof t.min ? i.minYArr[e] = t.min : "function" == typeof t.min && (i.minYArr[e] = t.min(i.minY)), i.minY = i.minYArr[e])
                    ...
                    i.minYArr[e] = t.niceMin,
                    i.maxYArr[e] = t.niceMax
                ...
                if (i.isXNumeric && function() {
                    for (var t = 0; t < i.series.length; t++)
                        if (i.labels[t])
                            for (var e = 0; e < i.labels[t].length; e++)
                                null !== i.labels[t][e] && I.isNumber(i.labels[t][e]) && (i.maxX = Math.max(i.maxX, i.labels[t][e]), i.initialMaxX = Math.max(i.maxX, i.labels[t][e]), i.minX = Math.min(i.minX, i.labels[t][e]), i.initialMinX = Math.min(i.minX, i.labels[t][e]))
                    ...
                    if (void 0 === e.xaxis.tickAmount ? (t = Math.round(i.svgWidth / 150), "numeric" === e.xaxis.type && i.dataPoints < 30 && (t = i.dataPoints - 1), t > i.dataPoints && 0 !== i.dataPoints && (t = i.dataPoints - 1)) : "dataPoints" === e.xaxis.tickAmount ? (1 < i.series.length && (t = i.series[i.maxValsInArrayIndex].length - 1), i.isXNumeric && (t = i.maxX - i.minX - 1)) : t = e.xaxis.tickAmount, i.xTickAmount = t, void 0 !== e.xaxis.max && "number" == typeof e.xaxis.max && (i.maxX = e.xaxis.max), void 0 !== e.xaxis.min && "number" == typeof e.xaxis.min && (i.minX = e.xaxis.min), void 0 !== e.xaxis.range && (i.minX = i.maxX - e.xaxis.range), i.minX !== Number.MAX_VALUE && i.maxX !== -Number.MAX_VALUE)
                        if (e.xaxis.convertedCatToNumeric && !i.dataFormatXNumeric) {
                            ...
                            i.xAxisScale = this.scales.setXScale(i.minX, i.maxX);
                    else
                        i.xAxisScale = this.scales.linearScale(1, t, t),
                        i.noLabelsProvided && 0 < i.labels.length && (i.xAxisScale = this.scales.linearScale(1, i.labels.length, t - 1), i.seriesX = i.labels.slice());
                    ...
                    for (var e = 0; e < t.series.length; e++)
                        if (void 0 !== t.seriesZ[e])
                            for (var i = 0; i < t.seriesZ[e].length; i++)
                                null !== t.seriesZ[e][i] && I.isNumber(t.seriesZ[e][i]) && (t.maxZ = Math.max(t.maxZ, t.seriesZ[e][i]), t.minZ = Math.min(t.minZ, t.seriesZ[e][i]))
            }
        }, {
                ...
                if (t.series.length)
                    for (var a = 0; a < t.series[t.maxValsInArrayIndex].length; a++)
                        for (var s = 0, r = 0, n = 0; n < t.series.length; n++)
                            null !== t.series[n][a] && I.isNumber(t.series[n][a]) && (0 < t.series[n][a] ? s = s + parseFloat(t.series[n][a]) + 1e-4 : r += parseFloat(t.series[n][a])),
        ...
        st = (n(be, [{
                ...
                if (o.config.yaxis[n].labels.show)
                    for (var s = p; 0 <= s; s--)
                        !function(t) {
                            ...
                            t === p && (v = r),
                            u.add(r),
                            0 !== o.config.yaxis[n].labels.rotate && (a = l.rotateAroundCenter(v.node), s = l.rotateAroundCenter(r.node), r.node.setAttribute("transform", "rotate(".concat(o.config.yaxis[n].labels.rotate, " ").concat(a.x, " ").concat(s.y, ")"))),
                            x += f
                        }(s);
            ...
            value: function(t) {
                ...
                0 < c.length && (this.xaxisLabels = c.slice(), r = (h = c.slice()).length),
                ...
                if (e.config.xaxis.labels.show)
                    for (var g = d ? 0 : r; d ? g < d : 0 <= g; d ? g++ : g--) {
                        ...
                        u = l(u, g);
                        var p,
                            f = e.globals.gridWidth + e.globals.padHorizontal - (o - n + e.config.xaxis.labels.offsetX);
            ...
            value: function(t, e) {
                ...
                var o,
                    l,
                    h = i.globals.dom.baseEl.querySelector(".apexcharts-yaxis[rel='".concat(t, "'] .apexcharts-yaxis-title text"));
                null !== h && (r = h.getBoundingClientRect()),
                null !== h && (o = this.xPaddingForYAxisTitle(t, s, r, e), h.setAttribute("x", o.xPos - (e ? 10 : 0))),
                null !== h && (l = a.rotateAroundCenter(h), h.setAttribute("transform", "rotate(".concat(e ? "" : "-").concat(i.config.yaxis[t].title.rotate, " ").concat(l.x, " ").concat(l.y, ")")))
            }
        }, {
        ...
        rt = (n(xe, [{
            ...
            value: function(e) {
                ...
                "click" !== e.type || (t = a.globals.dom.baseEl.querySelector(".apexcharts-menu")) && t.classList.contains("apexcharts-menu-open") && "apexcharts-menu-icon" !== s && t.classList.remove("apexcharts-menu-open"),
                "mousedown" === e.type && (i = a.globals.dom.Paper.select(".apexcharts-resizable-element").members, Array.prototype.forEach.call(i, function(t) {
                    e.target.classList.contains("apexcharts-resizable-element") || e.target.classList.contains("svg_select_points") || t.selectize(!1)
                })),
                a.globals.clientX = "touchmove" === e.type ? e.touches[0].clientX : e.clientX,
                a.globals.clientY = "touchmove" === e.type ? e.touches[0].clientY : e.clientY
            }
        }]), xe),
        nt = (n(fe, [{
                ...
                0 !== a.responsive.length && ((r = a.responsive.slice()).sort(function(t, e) {
                    ...
                    if (e < i) {
                        ...
                        for (var s = 0; s < r.length; s++)
                            i < r[s].breakpoint && (t = P.extendArrayProps(n, r[s].options, l), t = I.extend(l.config, t), o.overrideResponsiveOptions(t))
        ...
        ct = (n(de, [{
            ...
            value: function() {
                ...
                ["fill", "stroke"].forEach(function(t) {
                    void 0 === s.config[t].colors ? s.globals[t].colors = a.isColorFn ? s.config.colors : d : s.globals[t].colors = s.config[t].colors.slice(),
                ...
                void 0 === s.config.plotOptions.radar.polygons.fill.colors ? s.globals.radarPolygons.fill.colors = ["dark" === s.config.theme.mode ? "#424242" : "#fff"] : s.globals.radarPolygons.fill.colors = s.config.plotOptions.radar.polygons.fill.colors.slice(),
        ...
        dt = (n(ce, [{
            ...
            value: function(t) {
                var e,
                    ...
                    r = a.offsetY,
                    n = "middle";
                "left" === a.align ? (s = 10, n = "start") : "right" === a.align && (s = i.globals.svgWidth - 10, n = "end"),
                s += a.offsetX,
                r = r + parseInt(a.style.fontSize, 10) + a.margin / 2,
                void 0 !== a.text && ((e = new Y(this.ctx).drawText({
                    x: s,
                    y: r,
                    text: a.text,
                    textAnchor: n,
        ...
        ut = (n(le, [{
            ...
            value: function(t) {
                var n = this,
                    ...
                    c = h.xaxis.type,
                    d = t.width;
                l.skipLastTimelinelabel = !1,
                l.skipFirstTimelinelabel = !1;
            ...
            value: function() {
                function i(t, e) {
                    var i = s.config.yaxis[e].floating,
                        a = 0;
                    0 < t.width && !i ? (a = t.width + l, -1 < s.globals.ignoreYAxisIndexes.indexOf(e) && (a = a - t.width - l)) : a = i || h.isYAxisHidden(e) ? 0 : 5,
        ...
        xt = (n(re, [{
            ...
            value: function() {
                ...
                t.translateX = t.translateX + this.gridPad.left + this.xPadLeft + (0 < e ? e + 4 : 0),
            ...
            value: function() {
                ...
                e.translateXAxisY = i.globals.rotateXLabels ? this.xAxisHeight / 8 : -4,
                e.translateXAxisX = i.globals.rotateXLabels && i.globals.isXNumeric && i.config.xaxis.labels.rotate <= -45 ? -this.xAxisWidth / 4 : 0,
                i.globals.isBarHorizontal && (e.rotateXLabels = !1, e.translateXAxisY = parseInt(i.config.xaxis.labels.style.fontSize, 10) / 1.5 * -1),
                e.translateXAxisY = e.translateXAxisY + i.config.xaxis.labels.offsetY,
                e.translateXAxisX = e.translateXAxisX + i.config.xaxis.labels.offsetX;
                ...
                function c() {
                    e.translateX = o,
                    e.gridHeight = e.svgHeight - t.lgRect.height - l - (t.isSparkline ? 0 : i.globals.rotateXLabels ? 10 : 15),
                ...
                case "bottom":
                    ...
                    break;
                case "top":
                    e.translateY = this.lgRect.height + h,
                    c();
                    break;
                case "left":
                    e.translateY = h,
        ...
        bt = (n(se, [{
            ...
            value: function(t) {
                ...
                r.globals.allSeriesCollapsed = r.globals.collapsedSeries.length === r.config.series.length,
                n = this._getSeriesBasedOnCollapsedState(n),
                this.lgCtx.ctx.updateHelpers._updateSeries(n, r.config.chart.animations.dynamicAnimation.enabled)
            }
        }, {
            ...
            value: function(t, e, i) {
                ...
                if (0 < t.length) {
                    for (var r = 0; r < t.length; r++)
                        t[r].index === i && (a.globals.axisCharts ? s[i].data = t[r].data.slice() : s[i] = t[r].data, t.splice(r, 1), e.splice(r, 1), a.globals.risingSeries.push(i));
        ...
        mt = (n(ae, [{
            ...
            value: function() {
                ...
                if ((i.legend.showForSingleSeries && 1 === e.series.length || this.isBarsDistributed || 1 < e.series.length || !e.axisCharts) && i.legend.show) {
                    ...
                    this.drawLegends(),
                    I.isIE11() ? document.getElementsByTagName("head")[0].appendChild(this.legendHelpers.getLegendStyles()) : this.legendHelpers.appendToForeignObject(),
            ...
            value: function() {
                ...
                for (var r = e.globals.legendFormatter, n = e.config.legend.inverseOrder, o = n ? a.length - 1 : 0; n ? 0 <= o : o <= a.length - 1; n ? o-- : o++) {
                    ...
                    if (0 < e.globals.ancillaryCollapsedSeriesIndices.length)
                        for (var g = 0; g < e.globals.ancillaryCollapsedSeriesIndices.length; g++)
                    ...
                    w.background = s[o],
                    w.color = s[o],
                    e.config.legend.markers.fillColors && e.config.legend.markers.fillColors[o] && (w.background = e.config.legend.markers.fillColors[o]),
                    w.height = Array.isArray(x) ? parseFloat(x[o]) + "px" : parseFloat(x) + "px",
                    w.width = Array.isArray(b) ? parseFloat(b[o]) + "px" : parseFloat(b) + "px",
                    ...
                    w.borderRadius = Array.isArray(y) ? parseFloat(y[o]) + "px" : parseFloat(y) + "px",
                    e.config.legend.markers.customHTML && (Array.isArray(e.config.legend.markers.customHTML) ? e.config.legend.markers.customHTML[o] && (u.innerHTML = e.config.legend.markers.customHTML[o]()) : u.innerHTML = e.config.legend.markers.customHTML()),
                    Y.setAttrs(u, {
                        rel: o + 1,
                        "data:collapsed": h || c
                    }),
                    ...
                    A.style.color = S,
                    A.style.fontSize = parseFloat(e.config.legend.fontSize) + "px",
                    ...
                    e.config.legend.showForZeroSeries || 0 === C.getSeriesTotalByIndex(o) && C.seriesHaveSameValues(o) && !C.isSeriesNull(o) && -1 === e.globals.collapsedSeriesIndices.indexOf(o) && -1 === e.globals.ancillaryCollapsedSeriesIndices.indexOf(o) && k.classList.add("apexcharts-hidden-zero-series"),
                    e.config.legend.showForNullSeries || C.isSeriesNull(o) && -1 === e.globals.collapsedSeriesIndices.indexOf(o) && -1 === e.globals.ancillaryCollapsedSeriesIndices.indexOf(o) && k.classList.add("apexcharts-hidden-null-series"),
                ...
                "heatmap" !== e.config.chart.type && !this.isBarsDistributed && e.config.legend.onItemClick.toggleDataSeries && e.globals.dom.elWrap.addEventListener("click", this.onLegendClick, !0),
                e.config.legend.onItemHover.highlightDataSeries && (e.globals.dom.elWrap.addEventListener("mousemove", this.onLegendHovered, !0), e.globals.dom.elWrap.addEventListener("mouseout", this.onLegendHovered, !0))
            }
        }, {
            key: "setLegendWrapXY",
            value: function(t, e) {
                var i,
                    ...
                    h = 0;
                "bottom" === n.config.legend.position ? h += n.globals.svgHeight - l.height / 2 : "top" === n.config.legend.position && (h = h + (0 < (s = (a = new xt(this.ctx)).dimHelpers.getTitleSubtitleCoords("title").height) ? s - 10 : 0) + (0 < (r = a.dimHelpers.getTitleSubtitleCoords("subtitle").height) ? r - 10 : 0)),
                o.style.position = "absolute",
                i = 0 + t + n.config.legend.offsetX,
                h = h + e + n.config.legend.offsetY,
                o.style.left = i + "px",
                o.style.top = h + "px",
                "bottom" === n.config.legend.position ? (o.style.top = "auto", o.style.bottom = 5 - n.config.legend.offsetY + "px") : "right" === n.config.legend.position && (o.style.left = "auto", o.style.right = 25 + n.config.legend.offsetX + "px"),
        ...
        vt = (n(ie, [{
            ...
            value: function() {
                ...
                o("zoom"),
                o("selection"),
                this.t.pan && r.config.chart.zoom.enabled && n.push({
                    el: this.elPan,
                ...
                r.globals.zoomEnabled ? this.elZoom.classList.add(this.selectedClass) : r.globals.panEnabled ? this.elPan.classList.add(this.selectedClass) : r.globals.selectionEnabled && this.elSelection.classList.add(this.selectedClass),
            ...
            value: function(a) {
                this.ctx.getSyncedCharts().forEach(function(t) {
                    ...
                    e.classList.contains(t.ctx.toolbar.selectedClass) ? e.classList.remove(t.ctx.toolbar.selectedClass) : e.classList.add(t.ctx.toolbar.selectedClass)
                })
            }
        }, {
        ...
        yt = function() {
            ...
            return n(a, [{
                ...
                value: function(t, e) {
                    ...
                    e.shiftKey ? (this.shiftWasPressed = !0, n.enableZoomPanFromToolbar("pan" === l ? "zoom" : "pan")) : this.shiftWasPressed && (n.enableZoomPanFromToolbar(l), this.shiftWasPressed = !1),
                ...
                value: function(t, e) {
                    ...
                    "function" == typeof o.config.chart.events.selection && o.globals.selectionEnabled && (clearTimeout(this.w.globals.selectionResizeTimer), this.w.globals.selectionResizeTimer = window.setTimeout(function() {
                ...
                value: function(t) {
                    var e,
                        ...
                        o = this.xyRatios,
                        l = this.ctx.toolbar;
                    n.startX > n.endX && (e = n.startX, n.startX = n.endX, n.endX = e),
                    n.startY > n.endY && (i = n.startY, n.startY = n.endY, n.endY = i);
                    var h,
                        c,
                        d,
                        g,
                    ...
                    r.config.yaxis.forEach(function(t, e) {
                        b.push(r.globals.yAxisScale[e].niceMax - o.yRatio[e] * n.startY),
                ...
                value: function(t) {
                    var e,
                        ...
                        s = this.w,
                        r = a;
                    void 0 !== s.globals.lastClientPosition.x && (e = s.globals.lastClientPosition.x - r.clientX, i = s.globals.lastClientPosition.y - r.clientY, Math.abs(e) > Math.abs(i) && 0 < e ? this.moveDirection = "left" : Math.abs(e) > Math.abs(i) && e < 0 ? this.moveDirection = "right" : Math.abs(i) > Math.abs(e) && 0 < i ? this.moveDirection = "up" : Math.abs(i) > Math.abs(e) && i < 0 && (this.moveDirection = "down")),
                ...
                value: function(t, e) {
                    ...
                    "left" === this.moveDirection ? (t = i.globals.minX + i.globals.gridWidth / 15 * a.xRatio, e = i.globals.maxX + i.globals.gridWidth / 15 * a.xRatio) : "right" === this.moveDirection && (t = i.globals.minX - i.globals.gridWidth / 15 * a.xRatio, e = i.globals.maxX - i.globals.gridWidth / 15 * a.xRatio),
                    (t < i.globals.initialMinX || e > i.globals.initialMaxX) && (t = i.globals.minX, e = i.globals.maxX);
                    var r = {
                        min: t,
                        max: e
                    };
        ...
        wt = (n(ee, [{
            ...
            value: function(t) {
                ...
                for (var u, p, f = null, x = [], b = 0; b < r.globals.seriesXvalues.length; b++)
        ...
        kt = (n(te, [{
            ...
            value: function(t) {
                ...
                for (var i = 0, a = d.globals.series.length - 1; i < d.globals.series.length; i++, a--)
                    !function(t, e) {
            ...
            value: function(t) {
                ...
                u[0] && u[0].classList.contains("apexcharts-tooltip-marker") && (o.config.tooltip.marker.fillColors && Array.isArray(o.config.tooltip.marker.fillColors) && (n = o.config.tooltip.marker.fillColors[e]), u[0].style.backgroundColor = n),
                ...
                r && u[0] && (null == h || -1 < o.globals.collapsedSeriesIndices.indexOf(e) ? u[0].parentNode.style.display = "none" : u[0].parentNode.style.display = o.config.tooltip.items.display)
            }
        }, {
        ...
        At = (n(Kt, [{
            ...
            value: function(t) {
                ...
                null !== r && (r.setAttribute("x", n), r.setAttribute("x1", n), r.setAttribute("x2", n), r.setAttribute("y2", s.globals.gridHeight), r.classList.add("apexcharts-active")),
                n < 0 && (n = 0),
                n > s.globals.gridWidth && (n = s.globals.gridWidth),
                a.blxaxisTooltip && (e = n, "tickWidth" !== s.config.xaxis.crosshairs.width && "barWidth" !== s.config.xaxis.crosshairs.width || (e = n + a.xcrosshairsWidth / 2), this.moveXAxisTooltip(e))
            }
        }, {
            key: "moveYCrosshairs",
            value: function(t) {
            ...
            value: function(t) {
                ...
                s -= r / 2,
                -1 === e.globals.ignoreYAxisIndexes.indexOf(t) ? (i.yaxisTTEls[t].classList.add("apexcharts-active"), i.yaxisTTEls[t].style.top = s + "px", i.yaxisTTEls[t].style.left = n + e.config.yaxis[t].tooltip.offsetX + "px") : i.yaxisTTEls[t].classList.remove("apexcharts-active")
            }
        }, {
            key: "moveTooltip",
            value: function(t, e) {
                ...
                c > r.globals.gridWidth - l.ttWidth - 10 && (c = r.globals.gridWidth - l.ttWidth),
                c < -20 && (c = -20),
                r.config.tooltip.followCursor && (i = n.getElGrid().getBoundingClientRect(), d = n.e.clientY + r.globals.translateY - i.top - l.ttHeight / 2),
                r.config.tooltip.followCursor || (c = (a = this.positionChecks(l, c, d)).x, d = a.y),
                isNaN(c) || (c += r.globals.translateX, o.style.left = c + "px", o.style.top = d + "px")
            }
        }, {
            key: "positionChecks",
            value: function(t, e, i) {
            ...
            value: function(t) {
                ...
                if (null !== h)
                    for (var c = 0; c < i.globals.series.length; c++) {
                        ...
                        g && g.length && (d = r[c][t][1], h[c].setAttribute("cx", a), null !== d && !isNaN(d) && d < i.globals.gridHeight && 0 < d ? (h[c] && h[c].setAttribute("r", o), h[c] && h[c].setAttribute("cy", d)) : h[c] && h[c].setAttribute("r", 0))
                    }
                this.moveXCrosshairs(a),
                e.fixedTooltip || (l = s || i.globals.gridHeight, this.moveTooltip(a, l, o))
            }
        }, {
            ...
            value: function(t) {
                ...
                i.fixedTooltip || (l = c || e.globals.gridHeight, this.moveTooltip(n, l))
            }
        }]), Kt),
        St = (n(Qt, [{
            ...
            value: function(t, e) {
                ...
                this.fixedTooltip || ("radar" === s.config.chart.type && (r = this.ttCtx.getElGrid().getBoundingClientRect(), n = this.ttCtx.e.clientX - r.left), this.tooltipPosition.moveTooltip(n, o, s.config.markers.hover.size))
            }
        }, {
            key: "enlargePoints",
            value: function(t) {
                for (var e = this.w, i = this.ttCtx, a = t, s = e.globals.dom.baseEl.querySelectorAll(".apexcharts-series:not(.apexcharts-series-collapsed) .apexcharts-marker"), r = e.config.markers.hover.size, n = 0; n < s.length; n++) {
                    ...
                    a === parseInt(h, 10) ? (this.newPointSize(a, s[n]), o = s[n].getAttribute("cx"), l = s[n].getAttribute("cy"), this.tooltipPosition.moveXCrosshairs(o), i.fixedTooltip || this.tooltipPosition.moveTooltip(o, l, r)) : this.oldPointSize(s[n])
                }
            }
        }, {
            key: "newPointSize",
        ...
        Ct = (n(Jt, [{
            ...
            value: function(t) {
                ...
                o.globals.isBarHorizontal && l.tooltipUtil.hasBars() || !o.config.tooltip.shared ? (d = u.x, g = u.y, e = Array.isArray(o.config.stroke.width) ? o.config.stroke.width[p] : o.config.stroke.width, c = d) : o.globals.comboCharts || o.config.tooltip.shared || (c /= 2),
                isNaN(g) ? g = o.globals.svgHeight - l.tooltipRect.ttHeight : g < 0 && (g = 0),
                d + l.tooltipRect.ttWidth > o.globals.gridWidth ? d -= l.tooltipRect.ttWidth : d < 0 && (d = 0),
                l.w.config.tooltip.followCursor && (i = l.getElGrid().getBoundingClientRect(), g = l.e.clientY - i.top),
                null === l.tooltip && (l.tooltip = o.globals.dom.baseEl.querySelector(".apexcharts-tooltip")),
                o.config.tooltip.shared || (0 < o.globals.comboBarCount ? l.tooltipPosition.moveXCrosshairs(c + e / 2) : l.tooltipPosition.moveXCrosshairs(c)),
                !l.fixedTooltip && (!o.config.tooltip.shared || o.globals.isBarHorizontal && l.tooltipUtil.hasBars()) && ((a = o.globals.isMultipleYAxis ? o.config.yaxis[s] && o.config.yaxis[s].reversed : o.config.yaxis[0].reversed) && (d -= l.tooltipRect.ttWidth) < 0 && (d = 0), h.style.left = d + o.globals.translateX + "px", s = parseInt(n.paths.parentNode.getAttribute("data:realIndex"), 10), !a || o.globals.isBarHorizontal && l.tooltipUtil.hasBars() || (g = g + f - 2 * (o.globals.series[p][x] < 0 ? f : 0)), l.tooltipRect.ttHeight + g > o.globals.gridHeight ? (g = o.globals.gridHeight - l.tooltipRect.ttHeight + o.globals.translateY, h.style.top = g + "px") : h.style.top = g + o.globals.translateY - l.tooltipRect.ttHeight / 2 + "px")
            }
        }, {
            key: "getBarTooltipXY",
            value: function(t) {
        ...
        Lt = (n($t, [{
            ...
            value: function() {
                for (var s = this.w, r = this.ttCtx, t = 0; t < s.config.yaxis.length; t++)
                    !function(i) {
            ...
            value: function() {
                ...
                o.xcrosshairsWidth = parseInt(n.config.xaxis.crosshairs.width, 10),
                n.globals.comboCharts ? null !== (t = n.globals.dom.baseEl.querySelector(".apexcharts-bar-area")) && "barWidth" === n.config.xaxis.crosshairs.width ? (e = parseFloat(t.getAttribute("barWidth")), o.xcrosshairsWidth = e) : "tickWidth" === n.config.xaxis.crosshairs.width && (i = n.globals.labels.length, o.xcrosshairsWidth = n.globals.gridWidth / i) : "tickWidth" === n.config.xaxis.crosshairs.width ? (a = n.globals.labels.length, o.xcrosshairsWidth = n.globals.gridWidth / a) : "barWidth" === n.config.xaxis.crosshairs.width && (null !== (s = n.globals.dom.baseEl.querySelector(".apexcharts-bar-area")) ? (r = parseFloat(s.getAttribute("barWidth")), o.xcrosshairsWidth = r) : o.xcrosshairsWidth = 1),
                n.globals.isBarHorizontal && (o.xcrosshairsWidth = 0),
                null !== l && 0 < o.xcrosshairsWidth && l.setAttribute("width", o.xcrosshairsWidth)
            }
        }, {
        ...
        Pt = (n(Zt, [{
            ...
            value: function(t) {
                var i = this.w;
                this.xyRatios = t,
                this.blxaxisTooltip = i.config.xaxis.tooltip.enabled && i.globals.axisCharts,
                ...
                i.globals.axisCharts && (this.axesTooltip.drawXaxisTooltip(), this.axesTooltip.drawYaxisTooltip(), this.axesTooltip.setXCrosshairWidth(), this.axesTooltip.handleYCrosshair(), e = new tt(this.ctx), this.xAxisTicksPositions = e.getXAxisTicksPositions()),
                !i.globals.comboCharts && !this.tConfig.intersect && "bar" !== i.config.chart.type && "rangeBar" !== i.config.chart.type || this.tConfig.shared || (this.showOnIntersect = !0),
            ...
            value: function() {
                ...
                if (t.globals.axisCharts && (s ? o = t.globals.dom.baseEl.querySelectorAll(".apexcharts-series[data\\:longestSeries='true'] .apexcharts-marker") : a ? o = t.globals.dom.baseEl.querySelectorAll(".apexcharts-series .apexcharts-bar-area, .apexcharts-series .apexcharts-candlestick-area, .apexcharts-series .apexcharts-rangebar-area") : "heatmap" === e && (o = t.globals.dom.baseEl.querySelectorAll(".apexcharts-series .apexcharts-heatmap")), o && o.length))
                    for (var u = 0; u < o.length; u++)
                        c.push(o[u].getAttribute("cy")),
                        d.push(o[u].getAttribute("cx"));
                ...
                this.showOnIntersect && (0 < (h = t.globals.dom.baseEl.querySelectorAll(".apexcharts-line-series .apexcharts-marker, .apexcharts-area-series .apexcharts-marker")).length && this.addPathsEventListeners(h, g), this.tooltipUtil.hasBars() && !this.tConfig.shared && this.addDatapointEventsListeners(g))
            }
        }, {
            ...
            value: function(a, s) {
                ...
                e.globals.axisCharts && (e.globals.minX === -1 / 0 && e.globals.maxX === 1 / 0 || 0 === e.globals.dataPoints) || (t.length ? t.forEach(function(t) {
            ...
            value: function(t) {
                ...
                i.e = s,
                !i.tooltipUtil.hasBars() || r.globals.comboCharts || i.isBarShared || this.tConfig.onDatasetHover.highlightDataSeries && new W(e).toggleSeriesOnHover(s, s.target.parentNode),
            ...
            value: function(t) {
                ...
                if (this.clientY = n, this.clientX = r, a.globals.capturedSeriesIndex = -1, a.globals.capturedDataPointIndex = -1, n < s.top || n > s.top + s.height)
                    ...
                    if (a.globals.isBarHorizontal && this.tooltipUtil.hasBars() && (c = !1), "mousemove" === e.type || "touchmove" === e.type || "mouseup" === e.type) {
                        ...
                        "mouseout" !== e.type && "touchend" !== e.type || this.handleMouseOut(i)
                }
            }
        }, {
            ...
            value: function(t, e, i, a, s) {
                ...
                if (n.config.legend.tooltipHoverFormatter) {
                    ...
                    for (var g = 0; g < d.length; g++) {
                        ...
                        if (r)
                            u.innerHTML = n.globals.collapsedSeriesIndices.indexOf(p) < 0 ? x : f;
                        else if (u.innerHTML = p === i ? x : f, i === p)
                            break
                    }
                }
                if (r) {
        ...
        Tt = function() {
            ...
            return n(e, [{
                ...
                value: function(v, y) {
                    ...
                    "100%" === k.config.chart.stackType && (v = k.globals.seriesPercent.slice()),
                    this.series = v,
                    this.totalItems = 0,
                    this.prevY = [],
                    this.prevX = [],
                    ...
                    for (var A = this.graphics.group({
                            class: "apexcharts-bar-series apexcharts-plot-series"
                        }), S = 0, C = 0, i = 0, a = 0; i < v.length; i++, a++)
                        !function(t, e) {
                            var i,
                                a,
                                s,
                            ...
                            w.isReversed = k.config.yaxis[w.yaxisIndex] && k.config.yaxis[w.yaxisIndex].reversed;
                            ...
                            w.xArrjF = [],
                            w.xArrjVal = [],
                            1 === w.prevY.length && w.prevY[0].every(function(t) {
                                return isNaN(t)
                ...
                value: function(t) {
                    for (var e, i, a = t.indexes, s = t.barHeight, r = t.strokeWidth, n = t.zeroW, o = t.x, l = t.y, h = t.yDivision, c = t.elSeries, d = this.w, g = l, u = a.i, p = a.j, f = 0, x = 0; x < this.prevXF.length; x++)
                        f += this.prevXF[x][p];
                    e = 0 < u ? (i = n, this.prevXVal[u - 1][p] < 0 ? i = 0 <= this.series[u][p] ? this.prevX[u - 1][p] + f - 2 * (this.isReversed ? f : 0) : this.prevX[u - 1][p] : 0 <= this.prevXVal[u - 1][p] && (i = 0 <= this.series[u][p] ? this.prevX[u - 1][p] : this.prevX[u - 1][p] - f + 2 * (this.isReversed ? f : 0)), i) : n,
                    o = null === this.series[u][p] ? e : e + this.series[u][p] / this.invertedYRatio - 2 * (this.isReversed ? this.series[u][p] / this.invertedYRatio : 0),
                    this.xArrj.push(o),
                ...
                value: function(t) {
                    ...
                    if (0 < h && !l.globals.isXNumeric || 0 < h && l.globals.isXNumeric && l.globals.seriesX[h - 1][c] === l.globals.seriesX[h][c]) {
                        ...
                        g = this.prevYF[0].every(function(t) {
                            return 0 === t
                        ...
                        g = l.globals.gridHeight - n;
                    a = g - this.series[h][c] / this.yRatio[this.yaxisIndex] + 2 * (this.isReversed ? this.series[h][c] / this.yRatio[this.yaxisIndex] : 0),
                    this.yArrj.push(a),
        ...
        It = (n(qt, [{
            ...
            value: function(t) {
                ...
                for (var h = o ? 0 : l.length - 1; o ? h < l.length : 0 <= h; o ? h++ : h--) {
                    ...
                    e.config.chart.dropShadow.enabled && (c = e.config.chart.dropShadow, new E(this.ctx).dropShadow(d, c, h));
                    for (var g = 0, u = 0; u < l[h].length; u++) {
                        var p = 1,
                            ...
                            b = x.color,
                            m = new I;
                        e.config.plotOptions.heatmap.enableShades && (p < 0 && (p = 0), b = "dark" === this.w.config.theme.mode ? I.hexToRgba(m.shadeColor(-1 * p, x.color), e.config.fill.opacity) : I.hexToRgba(m.shadeColor(p, x.color), e.config.fill.opacity)),
                        "image" === e.config.fill.type && (b = new R(this.ctx).fillPath({
                            seriesNumber: h,
                            dataPointIndex: u,
                        ...
                        e.config.chart.animations.enabled && !e.globals.dataChanged && (v = 1, e.globals.resized || (v = e.config.chart.animations.speed), this.animateHeatMap(A, g, n, s, r, v)),
                        e.globals.dataChanged && (y = 1, this.dynamicAnim.enabled && e.globals.shouldAnimate && (y = this.dynamicAnim.speed, w = (w = e.globals.previousPaths[h] && e.globals.previousPaths[h][u] && e.globals.previousPaths[h][u].color) || "rgba(255, 255, 255, 0)", this.animateHeatColor(A, I.isColorHex(w) ? w : I.rgb2hex(w), I.isColorHex(b) ? b : I.rgb2hex(b), y)));
            ...
            value: function(t, e) {
                ...
                void 0 !== s.colorScale.min && (l = s.colorScale.min < i.globals.minY ? s.colorScale.min : i.globals.minY, h = s.colorScale.max > i.globals.maxY ? s.colorScale.max : i.globals.maxY);
        ...
        Et = (n(jt, [{
            ...
            value: function(t) {
                ...
                for (var l = 0; l < t.length; l++) {
                    ...
                    n.push(h),
                    "polarArea" === this.chartType ? (n[l] = this.fullAngle / t.length, this.sliceSizes.push(i.globals.radialSize * t[l] / this.maxY)) : this.sliceSizes.push(i.globals.radialSize)
                }
                if (i.globals.dataChanged) {
                    ...
                    for (var u = 0; u < i.globals.previousPaths.length; u++)
                        c = this.fullAngle * I.negToZero(i.globals.previousPaths[u]) / d,
            ...
            value: function(t, e) {
                ...
                for (var g = 0; g < t.length; g++) {
                    ...
                    s.config.chart.dropShadow.enabled && (p = s.config.chart.dropShadow, r.dropShadow(m, p, g)),
                    ...
                    "pie" === this.chartType || "polarArea" === this.chartType ? v = I.polarToCartesian(this.centerX, this.centerY, s.globals.radialSize / 1.25 + s.config.plotOptions.pie.dataLabels.offset, (i + f / 2) % this.fullAngle) : "donut" === this.chartType && (v = I.polarToCartesian(this.centerX, this.centerY, (s.globals.radialSize + this.donutSize) / 2 + s.config.plotOptions.pie.dataLabels.offset, (i + f / 2) % this.fullAngle)),
                    u.add(m);
                    var y,
                        w,
                        k,
                        ...
                        P,
                        T = 0;
                    !this.initialAnim || s.globals.resized || s.globals.dataChanged ? this.animBeginArr.push(0) : (0 == (T = f / this.fullAngle * s.config.chart.animations.speed) && (T = 1), this.animDur = T + this.animDur, this.animBeginArr.push(this.animDur)),
                    this.dynamicAnim && s.globals.dataChanged ? this.animatePaths(m, {
                        size: this.sliceSizes[g],
                        endAngle: c,
                        startAngle: i,
                        prevStartAngle: a,
                    ...
                    s.config.plotOptions.pie.expandOnClick && "polarArea" !== this.chartType && m.click(this.pieClicked.bind(this, g)),
                    s.config.dataLabels.enabled && (y = v.x, w = v.y, k = 100 * f / this.fullAngle + "%", 0 != f && s.config.plotOptions.pie.dataLabels.minAngleToShowLabel < t[g] && (void 0 !== (A = s.config.dataLabels.formatter) && (k = A(s.globals.seriesPercent[g][0], {
                        seriesIndex: g,
                        w: s
            ...
            value: function(e, i, a, s, r, n) {
                ...
                0 !== n.dur ? e.animate(n.dur, t.globals.easing, n.animBeginArr[n.i]).afterAll(function() {
                    ...
                    d = u + (s - u) * t,
                    n.animateStartingPos && (d = r + (s - r) * t, g = i - r + (a - (i - r)) * t),
                    o = l.getPiePath({
                        me: l,
                        startAngle: g,
                        angle: d,
            ...
            value: function() {
                ...
                for (var c = t.globals.radialSize, d = c / (h - 1), g = 0; g < h - 1; g++) {
                    ...
                    t.config.yaxis[0].show && (u = a.drawYAxisTexts(this.centerX, this.centerY - c + parseInt(t.config.yaxis[0].labels.style.fontSize, 10) / 2, g, l[g]), r.add(u)),
                    s.add(p),
                    c -= d
                }
                this.ret.add(s),
        ...
        Xt = (n(_t, [{
            ...
            value: function(t) {
                var u = this,
                    ...
                    x = [],
                    b = new N(this.ctx);
                t.length && (this.dataPointsLen = t[p.globals.maxValsInArrayIndex].length),
                ...
                return this.yaxisLabels = this.graphics.group({
                    ...
                    t.forEach(function(t, e) {
                        ...
                        u.dataRadius[o][e] = u.dataRadiusOfPercent[o][e] * u.size,
            ...
            key: "drawPolygons",
            value: function(t) {
                for (var r = this, n = this.w, o = t.parent, a = new Mt(this.ctx), s = n.globals.yAxisScale[0].result.reverse(), e = s.length, i = [], l = this.size / (e - 1), h = 0; h < e; h++)
                    i[h] = l * h;
                i.reverse();
                var c = [],
                    d = [];
                i.forEach(function(t, a) {
                    ...
                    e.forEach(function(t, e) {
                        var i;
                        0 === a && (i = r.graphics.drawLine(t.x, t.y, 0, 0, Array.isArray(r.polygons.connectorColors) ? r.polygons.connectorColors[e] : r.polygons.connectorColors), d.push(i)),
            ...
            return n(s, [{
                ...
                value: function(t) {
                    ...
                    for (var o = 0; o < t.series.length; o++) {
                        ...
                        h.dropShadow.enabled && (u = h.dropShadow, s.dropShadow(p, u)),
                        l.add(p),
                ...
                value: function(t) {
                    ...
                    for (var f = p ? t.series.length - 1 : 0; p ? 0 <= f : f < t.series.length; p ? f-- : f++) {
                        ...
                        var b = a.fillPath({
                            ...
                            k = void 0;
                        e.globals.dataChanged && (v = this.startAngle, k = Math.round(this.totalAngle * I.negToZero(e.globals.previousPaths[f]) / 100) + v),
                        360 <= Math.abs(w) + Math.abs(m) && (w -= .01),
                        360 <= Math.abs(k) + Math.abs(v) && (k -= .01);
                        var A,
                            S = w - m,
                        ...
                        e.config.chart.dropShadow.enabled && (A = e.config.chart.dropShadow, s.dropShadow(L, A, f)),
                ...
                value: function(e, t, i, a) {
                    ...
                    return l.config.plotOptions.radialBar.hollow.imageClipped ? (h.clippedImgArea({
                        ...
                        this.move(e.centerX - s / 2 + l.config.plotOptions.radialBar.hollow.imageOffsetX, e.centerY - r / 2 + l.config.plotOptions.radialBar.hollow.imageOffsetY),
                        this.size(s, r)
                    }), t.add(o))), a
                }
            }, {
        ...
        Ft = (n(Gt, [{
            ...
            value: function(t) {
                var e = t.i,
                    ...
                    r = this.w;
                if (void 0 !== i[e][0])
                    a = (s = r.config.chart.stacked && 0 < e ? this.lineCtx.prevSeriesY[e - 1][0] : this.lineCtx.zeroY) - i[e][0] / this.lineCtx.yRatio[this.lineCtx.yaxisIndex] + 2 * (this.lineCtx.isReversed ? i[e][0] / this.lineCtx.yRatio[this.lineCtx.yaxisIndex] : 0);
        ...
        Rt = (n(Vt, [{
            ...
            value: function(t, e, i) {
                ...
                for (var l = [], h = 0; h < t.length; h++) {
                    ...
                    a.globals.isXNumeric && 0 < a.globals.seriesX.length && (u = (a.globals.seriesX[c][0] - a.globals.minX) / this.xRatio),
                    g.push(u);
                    var p,
                        f = u,
                        x = f,
            ...
            value: function(t) {
                for (var e = t.series, i = t.realIndex, a = t.i, s = t.x, r = t.y, n = t.pX, o = t.pY, l = t.pathsFrom, h = t.linePaths, c = t.areaPaths, d = t.seriesIndex, g = t.lineYPosition, u = t.xArrj, p = t.yArrj, f = this.w, x = new Y(this.ctx), b = this.yRatio, m = l.prevY, v = l.linePath, y = l.areaPath, w = l.pathFromLine, k = l.pathFromArea, A = I.isNumber(f.globals.minYArr[i]) ? f.globals.minYArr[i] : f.globals.minY, S = 1 < f.globals.dataPoints ? f.globals.dataPoints - 1 : f.globals.dataPoints, C = 0; C < S; C++) {
                    ...
                    f.globals.isXNumeric ? (L = f.globals.seriesX[i][C + 1], void 0 === f.globals.seriesX[i][C + 1] && (L = f.globals.seriesX[i][S - 1]), s = (L - f.globals.minX) / this.xRatio) : s += this.xDivision,
                    ...
                    r = P ? g - A / b[this.yaxisIndex] + 2 * (this.isReversed ? A / b[this.yaxisIndex] : 0) : g - e[a][C + 1] / b[this.yaxisIndex] + 2 * (this.isReversed ? e[a][C + 1] / b[this.yaxisIndex] : 0),
                    u.push(s),
                    p.push(r);
                    var T = this.lineHelpers.calculatePoints({
                        ...
                        y = z.areaPath,
                        v = z.linePath;
                    this.appendPathFrom && (w += x.line(s, this.zeroY), k += x.line(s, this.zeroY)),
        ...
        Dt = (n(Bt, [{
            ...
            value: function(t, e) {
                ...
                a < .005 ? o.globals.disableZoomIn = !0 : 5e4 < a && (o.globals.disableZoomOut = !0);
                ...
                return b.filter(function(t) {
                    var e = 1,
                        ...
                        a = t.value;
                    void 0 !== o.config.xaxis.tickAmount && (i = o.config.xaxis.tickAmount),
            ...
            value: function(t) {
                ...
                var i = t.firstVal,
                    ...
                    g = h,
                    u = e(c, a, s);
                0 === i.minHour && 1 === i.minDate && (d = 0, g = I.monthMod(i.minMonth), l = "month", c = i.minDate, n++),
                this.timeScaleArray.push({
                    position: d,
                    value: g,
                    unit: l,
            ...
            value: function(t) {
                ...
                for (var x, b, m = d, v = 0; v < o; v++) {
                    h = "hour",
                    24 <= u && (u = 0, h = "day", x = p += 1, b = f, x > l.determineDaysOfMonths(b + 1, r) && (b += p = 1), f = e(p, f = {
                        month: b,
                        date: p
                    }.month));
        ...
        Ht = (n(Wt, [{
            ...
            value: function() {
                var t = this.w.globals,
                    e = this.w.config,
                    i = e.chart.type;
                t.axisCharts = -1 < ["line", "area", "bar", "rangeBar", "candlestick", "scatter", "bubble", "radar", "heatmap"].indexOf(i),
                t.xyCharts = -1 < ["line", "area", "bar", "rangeBar", "candlestick", "scatter", "bubble"].indexOf(i),
            ...
            value: function(i, t) {
                ...
                if (r.comboCharts)
                    ...
                    0 < c.series.length && (a.config.chart.stacked ? (u = new Tt(this.ctx, t), y.push(u.draw(c.series, c.i))) : (p = new V(this.ctx, t), y.push(p.draw(c.series, c.i)))),
                    0 < n.series.length && y.push(e.draw(n.series, "line", n.i)),
                    0 < d.series.length && y.push(g.draw(d.series, d.i)),
                    0 < l.series.length && (f = new Rt(this.ctx, t, !0), y.push(f.draw(l.series, "scatter", l.i))),
                    0 < h.series.length && (x = new Rt(this.ctx, t, !0), y.push(x.draw(h.series, "bubble", h.i)));
                else
                    switch (s.chart.type) {
                    case "line":
            ...
            value: function() {
                ...
                "%" === s ? I.isNumber(a[0]) && (0 === a[0].width && (a = I.getDimensions(this.el.parentNode)), t.svgWidth = a[0] * parseInt(e.chart.width, 10) / 100) : "px" !== s && "" !== s || (t.svgWidth = parseInt(e.chart.width, 10)),
                "auto" !== t.svgHeight && "" !== t.svgHeight ? "%" === e.chart.height.toString().split(/[0-9]+/g).pop() ? (i = I.getDimensions(this.el.parentNode), t.svgHeight = i[1] * parseInt(e.chart.height, 10) / 100) : t.svgHeight = parseInt(e.chart.height, 10) : t.axisCharts ? t.svgHeight = t.svgWidth / 1.61 : t.svgHeight = t.svgWidth / 1.2,
            ...
            value: function() {
                ...
                "top" !== t.config.legend.position && "bottom" !== t.config.legend.position || !t.config.legend.show || t.config.legend.floating || (i = new mt(this.ctx).legendHelpers.getLegendBBox().clwh + 10);
                var s,
                    r,
            ...
            key: "isMultipleY",
            value: function() {
                if (this.w.config.yaxis.constructor === Array && 1 < this.w.config.yaxis.length)
            ...
            value: function() {
                ...
                r.config.chart.brush.enabled && "function" != typeof r.config.chart.events.selection && ((e = r.config.chart.brush.targets || [r.config.chart.brush.target]).forEach(function(t) {
                    ...
                    "function" != typeof e.w.config.chart.events.zoomed && (e.w.config.chart.events.zoomed = function() {
        ...
        Nt = (n(Ot, [{
            ...
            value: function(i) {
                ...
                this.ctx.w.globals.isExecCalled && (e = [this.ctx], this.ctx.w.globals.isExecCalled = !1),
                e.forEach(function(t) {
                    var e = t.w;
    ...
    function jt(t) {
        ...
        this.lineColorArr = void 0 !== e.globals.stroke.colors ? e.globals.stroke.colors : e.globals.colors,
        this.defaultSize = e.globals.svgHeight < e.globals.svgWidth ? e.globals.gridHeight : e.globals.gridWidth,
    ...
    function ye(t) {
        ...
        this.axesUtils = new Q(t),
        this.isTimelineBar = "datetime" === e.config.xaxis.type && e.globals.seriesRangeBarTimeline.length,
        0 < e.globals.timescaleLabels.length && (this.xaxisLabels = e.globals.timescaleLabels.slice())
    }
    function we(t) {
        r(this, we),
        this.ctx = t,
    ...
    function Me(t, e) {
        ...
        this.xyRatios = e,
        null !== this.xyRatios && (this.xRatio = e.xRatio, this.initialXRatio = e.initialXRatio, this.yRatio = e.yRatio, this.invertedXRatio = e.invertedXRatio, this.invertedYRatio = e.invertedYRatio, this.baseLineY = e.baseLineY, this.baseLineInvertedY = e.baseLineInvertedY),
        this.yaxisIndex = 0,
        this.seriesLen = 0,
    ...
    function Ge(t) {
        ...
        case "A":
            t = (e = function(t, e) {
                ...
                for (1 < (a = (i = new SVG.Point((F.x - R.x) / 2, (F.y - R.y) / 2).transform((new SVG.Matrix).rotate(I))).x * i.x / (T * T) + i.y * i.y / (z * z)) && (T *= a = Math.sqrt(a), z *= a), s = (new SVG.Matrix).rotate(I).scale(1 / T, 1 / z).rotate(-I), F = F.transform(s), o = (r = [(R = R.transform(s)).x - F.x, R.y - F.y])[0] * r[0] + r[1] * r[1], n = Math.sqrt(o), r[0] /= n, r[1] /= n, l = o < 4 ? Math.sqrt(1 - o / 4) : 0, M === E && (l *= -1), h = new SVG.Point((R.x + F.x) / 2 + l * -r[1], (R.y + F.y) / 2 + l * r[0]), c = new SVG.Point(F.x - h.x, F.y - h.y), d = new SVG.Point(R.x - h.x, R.y - h.y), g = Math.acos(c.x / Math.sqrt(c.x * c.x + c.y * c.y)), c.y < 0 && (g *= -1), u = Math.acos(d.x / Math.sqrt(d.x * d.x + d.y * d.y)), d.y < 0 && (u *= -1), E && u < g && (u += 2 * Math.PI), !E && g < u && (u -= 2 * Math.PI), b = [], p = (u - (m = g)) / (f = Math.ceil(2 * Math.abs(g - u) / Math.PI)), x = 4 * Math.tan(p / 4) / 3, k = 0; k <= f; k++)
                    y = Math.cos(m),
                    v = Math.sin(m),
    ...
    L = function(s, r) {
        ...
        if (h.ns = "http://www.w3.org/2000/svg", h.xmlns = "http://www.w3.org/2000/xmlns/", h.xlink = "http://www.w3.org/1999/xlink", h.svgjs = "http://svgjs.com/svgjs", h.supported = !0, !h.supported)
            return !1;
        h.did = 1e3,
        h.eid = function(t) {
        ...
        h.Color = function(t) {
            ...
            this.g = 0,
            this.b = 0,
            t && ("string" == typeof t ? h.regex.isRgb.test(t) ? (e = h.regex.rgb.exec(t.replace(h.regex.whitespace, "")), this.r = parseInt(e[1]), this.g = parseInt(e[2]), this.b = parseInt(e[3])) : h.regex.isHex.test(t) && (e = h.regex.hex.exec(4 == (i = t).length ? ["#", i.substring(1, 2), i.substring(1, 2), i.substring(2, 3), i.substring(2, 3), i.substring(3, 4), i.substring(3, 4)].join("") : i), this.r = parseInt(e[1], 16), this.g = parseInt(e[2], 16), this.b = parseInt(e[3], 16)) : "object" === v(t) && (this.r = t.r, this.g = t.g, this.b = t.b))
        },
        h.extend(h.Color, {
            toString: function() {
                return this.toHex()
        ...
        for (var l = {
            ...
            }, t = "mlhvqtcsaz".split(""), e = 0, i = t.length; e < i; ++e)
            l[t[e]] = function(r) {
            ...
            toString: function() {
                return function(t) {
                    for (var e = 0, i = t.length, a = ""; e < i; e++)
                        a += t[e][0],
                        null != t[e][1] && (a += t[e][1], null != t[e][2] && (a += " ", a += t[e][2], null != t[e][3] && (a += " ", a += t[e][3], a += " ", a += t[e][4], null != t[e][5] && (a += " ", a += t[e][5], a += " ", a += t[e][6], null != t[e][7] && (a += " ", a += t[e][7])))));
                    return a + " "
                }(this.value)
            },
            move: function(t, e) {
        ...
        h.Number = h.invent({
            create: function(t, e) {
                this.value = 0,
                this.unit = e || "",
                "number" == typeof t ? this.value = isNaN(t) ? 0 : isFinite(t) ? t : t < 0 ? -34e37 : 34e37 : "string" == typeof t ? (e = t.match(h.regex.numberAndUnit)) && (this.value = parseFloat(e[1]), "%" == e[5] ? this.value /= 100 : "s" == e[5] && (this.value *= 1e3), this.unit = e[5]) : t instanceof h.Number && (this.value = t.valueOf(), this.unit = t.unit)
            },
            extend: {
                toString: function() {
        ...
        h.Element = h.invent({
            create: function(t) {
                ...
                this._event = null,
                this.dom = {},
                (this.node = t) && (this.type = t.nodeName, (this.node.instance = this)._stroke = t.getAttribute("stroke") || this._stroke)
            },
            extend: {
                x: function(t) {
                ...
                parent: function(t) {
                    ...
                    for (; e && e.node instanceof s.SVGElement;) {
                        if ("string" == typeof t ? e.matches(t) : e instanceof t)
                            return e;
                        if (!e.node.parentNode || "#document" == e.node.parentNode.nodeName)
                            return null;
                ...
                svg: function(t) {
                    ...
                    if (!(t && this instanceof h.Parent))
                        return e.appendChild(t = r.createElement("svg")), this.writeDataToDom(), t.appendChild(this.node.cloneNode(!0)), e.innerHTML.replace(/^<svg>/, "").replace(/<\/svg>$/, "");
        ...
        h.FX = h.invent({
            ...
            extend: {
                ...
                startAnimFrame: function() {
                    this.stopAnimFrame(),
                    this.animationFrame = s.requestAnimationFrame(function() {
                        this.step()
                    }.bind(this))
                },
                ...
                initAnimations: function() {
                    ...
                    for (var i in e.animations) {
                        ...
                        for (var a = t.length; a--;)
                            e.animations[i][a] instanceof h.Number && (t[a] = new h.Number(t[a])),
                    ...
                    for (var i in e.styles)
                        e.styles[i] = new h.MorphObj(this.target().style(i), e.styles[i]);
                ...
                step: function(t) {
                    ...
                    !1 !== this.situation.loops ? (e = Math.max(this.absPos, 0), i = Math.floor(e), !0 === this.situation.loops || i < this.situation.loops ? (this.pos = e - i, a = this.situation.loop, this.situation.loop = i) : (this.absPos = this.situation.loops, this.pos = 1, a = this.situation.loop - 1, this.situation.loop = this.situation.loops), this.situation.reversing && (this.situation.reversed = this.situation.reversed != Boolean((this.situation.loop - a) % 2))) : (this.absPos = Math.min(this.absPos, 1), this.pos = this.absPos),
        ...
        h.Box = h.invent({
            create: function(t, e, i, a) {
                if (!("object" !== v(t) || t instanceof h.Element))
                    return h.Box.call(this, null != t.left ? t.left : t.x, null != t.top ? t.top : t.y, t.width, t.height);
                var s;
                4 == arguments.length && (this.x = t, this.y = e, this.width = i, this.height = a),
                null == (s = this).x && (s.x = 0, s.y = 0, s.width = 0, s.height = 0),
                s.w = s.width,
                s.h = s.height,
                s.x2 = s.x + s.width,
                s.y2 = s.y + s.height,
        ...
        h.Matrix = h.invent({
            ...
            extend: {
                ...
                native: function() {
                    for (var t = h.parser.native.createSVGMatrix(), e = m.length - 1; 0 <= e; e--)
                        t[m[e]] = this[m[e]];
                    return t
                },
                toString: function() {
        ...
        h.extend(h.Element, {
            attr: function(t, e, i) {
                if (null == t) {
                    for (t = {}, i = (e = this.node.attributes).length - 1; 0 <= i; i--)
                        t[e[i].nodeName] = h.regex.isNumber.test(e[i].nodeValue) ? parseFloat(e[i].nodeValue) : e[i].nodeValue;
                    return t
                }
                if ("object" === v(t))
                    for (var a in t)
                    ...
                    if (null == e)
                        return null == (e = this.node.getAttribute(t)) ? h.defaults.attrs[t] : h.regex.isNumber.test(e) ? parseFloat(e) : e;
                    "stroke-width" == t ? this.attr("stroke", 0 < parseFloat(e) ? this._stroke : null) : "stroke" == t && (this._stroke = e),
                    "fill" != t && "stroke" != t || (h.regex.isImage.test(e) && (e = this.doc().defs().image(e, 0, 0)), e instanceof h.Image && (e = this.doc().defs().pattern(0, 0, function() {
                        this.add(e)
                    }))),
        ...
        h.extend(h.Element, {
            style: function(t, e) {
                ...
                if (arguments.length < 2)
                    ...
                    this.node.style[n(t)] = null === e || h.regex.isBlank.test(e) ? "" : e;
                return this
            }
        }),
        h.Parent = h.invent({
        ...
        h.off = function(t, e, i) {
            ...
            if (-1 != a)
                if (i) {
                    ...
                    for (var l in h.listeners[a])
                        h.off(t, l);
                    delete h.listeners[a],
                    delete h.handlerMap[a]
                }
        },
        h.extend(h.Element, {
            on: function(t, e, i, a) {
                ...
                text: function(t) {
                    if (void 0 === t) {
                        ...
                        for (var e = this.node.childNodes, i = 0, a = e.length; i < a; ++i)
                            0 != i && 3 != e[i].nodeType && 1 == h.adopt(e[i]).dom.newLined && (t += "\n"),
                            t += e[i].textContent;
                        return t
                    }
        ...
        ["fill", "stroke"].forEach(function(i) {
            ...
            t[i] = function(t) {
                if (void 0 === t)
                    return this;
                if ("string" == typeof t || h.Color.isRgb(t) || t && "function" == typeof t.fill)
                    this.attr(i, t);
                else
        ...
        h.Set.inherit = function() {
            ...
            for (var e in h.Shape.prototype)
                "function" == typeof h.Shape.prototype[e] && "function" != typeof h.Set.prototype[e] && t.push(e);
            for (var e in t.forEach(function(i) {
                h.Set.prototype[i] = function() {
                    for (var t = 0, e = this.members.length; t < e; t++)
                        this.members[t] && "function" == typeof this.members[t][i] && this.members[t][i].apply(this.members[t], arguments);
                    return "animate" == i ? this.fx || (this.fx = new h.FX.Set(this)) : this
                }
            }), t = [], h.FX.prototype)
                "function" == typeof h.FX.prototype[e] && "function" != typeof h.FX.Set.prototype[e] && t.push(e);
            t.forEach(function(i) {
                h.FX.Set.prototype[i] = function() {
                    for (var t = 0, e = this.set.members.length; t < e; t++)
                        this.set.members[t].fx[i].apply(this.set.members[t].fx, arguments);
                    return this
                }
            })
        },
        ...
        morph: function(t) {
            for (var e = this.value, i = this.parse(t), a = 0, s = 0; !1 !== a || !1 !== s;) {
                var r,
                    n = _e(e, !1 !== a && a + 1),
                    o = _e(i, !1 !== s && s + 1);
                !1 === a && (a = 0 == (r = new SVG.PathArray(l.start).bbox()).height || 0 == r.width ? e.push(e[0]) - 1 : e.push(["M", r.x + r.width / 2, r.y + r.height / 2]) - 1),
                !1 === s && (s = 0 == (r = new SVG.PathArray(l.dest).bbox()).height || 0 == r.width ? i.push(i[0]) - 1 : i.push(["M", r.x + r.width / 2, r.y + r.height / 2]) - 1);
                var l = function(t, e, i, a, s, r, n) {
                        for (var o = t.slice(e, i || n), l = a.slice(s, r || n), h = 0, c = {
                                ...
                                pos: [0, 0],
                                start: [0, 0]
                            }; o[h] = Be.call(c, o[h]), l[h] = Be.call(d, l[h]), o[h][0] != l[h][0] || "M" == o[h][0] || "A" == o[h][0] && (o[h][4] != l[h][4] || o[h][5] != l[h][5]) ? (Array.prototype.splice.apply(o, [h, 1].concat(Ge.call(c, o[h]))), Array.prototype.splice.apply(l, [h, 1].concat(Ge.call(d, l[h])))) : (o[h] = Ve.call(c, o[h]), l[h] = Ve.call(d, l[h])), ++h != o.length || h != l.length;)
                            h == o.length && o.push(["C", c.pos[0], c.pos[1], c.pos[0], c.pos[1], c.pos[0], c.pos[1]]),
                            h == l.length && l.push(["C", d.pos[0], d.pos[1], d.pos[0], d.pos[1], d.pos[0], d.pos[1]]);
                        return {
                            start: o,
                            dest: l
                        }
    ...
    We.prototype.init = function(t, e) {
        ...
        for (var s in r) {
            ...
            "string" == typeof n ? n = 0 < n.length ? n.split(/\s*,\s*/i) : [] : "boolean" == typeof n && "points" === r[s] && (n = n ? a : []),
            this.options[r[s]] = n
        }
    ...
    We.prototype.selectRect = function(t) {
        ...
        this.options.points.length && this.rectSelection.set.length() < 2 && (this.options.points.map(function(t, e) {
    ...
    We.prototype.cleanup = function() {
        !this.rectSelection.isSelected && this.rectSelection.set && (this.rectSelection.set.each(function() {
            this.remove()
        }), this.rectSelection.set.clear(), delete this.rectSelection.set),
        !this.pointSelection.isSelected && this.pointSelection.set && (this.pointSelection.set.each(function() {
            this.remove()
        }), this.pointSelection.set.clear(), delete this.pointSelection.set),
    ...
    function() {
        ...
        var e,
            s,
            r = (e = window.requestAnimationFrame || window.mozRequestAnimationFrame || window.webkitRequestAnimationFrame || function(t) {
    ...
    var je = (n(Ze, [{
        ...
        Ue = (n(qe, [{
            ...
            value: function() {
                var e = this;
                this.w.globals.dom.Paper.node.parentNode.parentNode.style.minHeight = "unset",
                this.ctx.eventList.forEach(function(t) {
    ...
    return n($e, [{
        ...
        value: function() {
            ...
            return new Promise(function(t, e) {
                if (null !== s.el) {
                    ...
                    s.w.config.chart.id && Apex._chartInstances.push({
                    ...
                    window.addResizeListener(s.el.parentNode, s._parentResizeCallback.bind(s));
                    var a = s.create(s.w.config.series, {});
                    if (!a)
                        return t(s);
                    s.mount(a).then(function() {
                        "function" == typeof s.w.config.chart.events.mounted && s.w.config.chart.events.mounted(s, s.w),
        ...
        value: function(t, e) {
            ...
            var a = this.w.globals;
            if (a.noData = !1, a.animationEnded = !1, this.responsive.checkResponsiveConfig(e), i.config.xaxis.convertedCatToNumeric && new j(i.config).convertCatToNumericXaxis(i.config, this.ctx), null === this.el)
        ...
        value: function() {
            ...
            return new Promise(function(t, e) {
                if (null === h.el)
                    return e(new Error("Not enough data to display or target element not found"));
                null !== l && !c.globals.allSeriesCollapsed || h.series.handleNoData(),
                ...
                "back" === c.config.grid.position && i && c.globals.dom.elGraphical.add(i.el);
                var a,
                    s = new tt(o.ctx),
                    r = new st(o.ctx);
                if (null !== i && (s.xAxisLabelCorrections(i.xAxisTickWidth), r.setYAxisTextAlignments()), "back" === c.config.annotations.position && (c.globals.dom.Paper.add(c.globals.dom.elAnnotations), h.annotations.drawAxesAnnotations()), l.elGraph instanceof Array)
                    ...
                    c.globals.dom.elGraphical.add(l.elGraph);
                "front" === c.config.grid.position && i && c.globals.dom.elGraphical.add(i.el),
                "front" === c.config.xaxis.crosshairs.position && h.crosshairs.drawXCrosshairs(),
                "front" === c.config.yaxis[0].crosshairs.position && h.crosshairs.drawYCrosshairs(),
                "front" === c.config.annotations.position && (c.globals.dom.Paper.add(c.globals.dom.elAnnotations), h.annotations.drawAxesAnnotations()),
                c.globals.noData || (c.config.tooltip.enabled && !c.globals.noData && h.w.globals.tooltip.drawTooltip(l.xyRatios), c.globals.axisCharts && (c.globals.isXNumeric || c.config.xaxis.convertedCatToNumeric) ? (c.config.chart.zoom.enabled || c.config.chart.selection && c.config.chart.selection.enabled || c.config.chart.pan && c.config.chart.pan.enabled) && h.zoomPanSelection.init({
                    xyRatios: l.xyRatios
                ...
                c.globals.axisCharts || c.globals.noData || h.core.resizeNonAxisCharts(),
                t(h)
            })
        }
    }, {
        ...
        value: function(a) {
            ...
            return new Promise(function(t, e) {
                ...
                s.mount(i).then(function() {
                    "function" == typeof s.w.config.chart.events.updated && s.w.config.chart.events.updated(s, s.w),
        ...
        value: function(t, e) {
            ...
            if (i) {
                ...
                if (-1 !== i.publicMethods.indexOf(e)) {
                    for (var s = arguments.length, r = new Array(2 < s ? s - 2 : 0), n = 2; n < s; n++)
                        r[n - 2] = arguments[n];
                    a = i[e].apply(i, r)
                }
                return a
