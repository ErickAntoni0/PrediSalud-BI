!function(t, e) {
    ...
    var n,
        ...
        l = ((n = c.prototype).close = function(t) {
            ...
            g.removeData(this._element, "bs.alert"),
            this._element = null
            ...
            g(e).hasClass("fade") ? (t = m.getTransitionDurationFromElement(e), g(e).one(m.TRANSITION_END, function(t) {
    ...
    g(document).on("click.bs.alert.data-api", '[data-dismiss="alert"]', l._handleDismiss(new l)),
    ...
    var h,
        ...
        f = ((h = p.prototype).toggle = function() {
            ...
            !o || (t = this._element.querySelector('input:not([type="hidden"])')) && ("radio" === t.type && (t.checked && this._element.classList.contains("active") ? n = !1 : (e = o.querySelector(".active")) && g(e).removeClass("active")), n && ("checkbox" !== t.type && "radio" !== t.type || (t.checked = !this._element.classList.contains("active")), g(t).trigger("change")), t.focus(), i = !1),
            this._element.hasAttribute("disabled") || this._element.classList.contains("disabled") || (i && this._element.setAttribute("aria-pressed", !this._element.classList.contains("active")), n && g(this._element).toggleClass("active"))
        }, h.dispose = function() {
            g.removeData(this._element, "bs.button"),
            this._element = null
    ...
    g(document).on("click.bs.button.data-api", '[data-toggle^="button"]', function(t) {
        var e = t.target,
            n = e;
        if (g(e).hasClass("btn") || (e = g(e).closest(".btn")[0]), !e || e.hasAttribute("disabled") || e.classList.contains("disabled"))
            t.preventDefault();
        else {
            var i = e.querySelector('input:not([type="hidden"])');
            if (i && (i.hasAttribute("disabled") || i.classList.contains("disabled")))
                return void t.preventDefault();
            "LABEL" === n.tagName && i && "checkbox" === i.type && t.preventDefault(),
    ...
    var _,
        ...
        T = ((_ = C.prototype).next = function() {
            ...
            t || (this._isPaused = !0),
            this._element.querySelector(".carousel-item-next, .carousel-item-prev") && (m.triggerTransitionEnd(this._element), this.cycle(!0)),
            ...
            h && g(h).hasClass("active") ? this._isSliding = !1 : !this._triggerSlideEvent(h, f).isDefaultPrevented() && l && h && (this._isSliding = !0, d && this.pause(), this._setActiveIndicatorElement(h), o = g.Event("slid.bs.carousel", {
                ...
                g(h).removeClass(n + " " + i).addClass("active"),
                g(l).removeClass("active " + i + " " + n),
                a._isSliding = !1,
                setTimeout(function() {
            ...
            return this.each(function() {
                ...
                if (t || (t = new C(this, e), g(this).data("bs.carousel", t)), "number" == typeof i)
                    t.to(i);
    ...
    g(document).on("click.bs.carousel.data-api", "[data-slide], [data-slide-to]", T._dataApiClickHandler),
    ...
    var S,
        ...
        I = ((S = O.prototype).toggle = function() {
            ...
            this._isTransitioning || g(this._element).hasClass("show") || (this._parent && 0 === (t = [].slice.call(this._parent.querySelectorAll(".show, .collapsing")).filter(function(t) {
                ...
                g(r._element).removeClass("collapsing").addClass("collapse show"),
                r._element.style[i] = "",
            ...
            if (!this._isTransitioning && g(this._element).hasClass("show")) {
                ...
                if (g(this._element).trigger(e), !e.isDefaultPrevented()) {
                    ...
                    g(this._element).addClass("collapsing").removeClass("collapse show");
                    ...
                    g(this._element).one(m.TRANSITION_END, function() {
                        ...
                        g(t._element).removeClass("collapsing").addClass("collapse").trigger("hidden.bs.collapse")
            ...
            if (void 0 === t && (t = !1), !(this._element.disabled || g(this._element).hasClass("disabled") || g(this._menu).hasClass("show"))) {
                ...
                if (g(i).trigger(n), !n.isDefaultPrevented()) {
                    if (!this._inNavbar && t) {
                        ...
                        var o = this._element;
                        "parent" === this._config.reference ? o = i : m.isElement(this._config.reference) && (o = this._config.reference, void 0 !== this._config.reference.jquery && (o = this._config.reference[0])),
                    ...
                    g(i).toggleClass("show").trigger(g.Event("shown.bs.dropdown", e))
                }
            }
        }, j.hide = function() {
            var t,
            ...
            if (!(/input|textarea/i.test(t.target.tagName) ? 32 === t.which || 27 !== t.which && (40 !== t.which && 38 !== t.which || g(t.target).closest(".dropdown-menu").length) : !L.test(t.which)) && !this.disabled && !g(this).hasClass("disabled")) {
                ...
                if (n || 27 !== t.which) {
                    if (t.preventDefault(), t.stopPropagation(), !n || n && (27 === t.which || 32 === t.which))
                        return 27 === t.which && g(e.querySelector('[data-toggle="dropdown"]')).trigger("focus"), void g(this).trigger("click");
                    var i,
    ...
    var B,
        ...
        W = ((B = V.prototype).toggle = function(t) {
            ...
            var e,
                ...
                o = this;
            t && t.preventDefault(),
            this._isShown && !this._isTransitioning && (e = g.Event("hide.bs.modal"), g(this._element).trigger(e), this._isShown && !e.isDefaultPrevented() && (this._isShown = !1, (n = g(this._element).hasClass("fade")) && (this._isTransitioning = !0), this._setEscapeEvent(), this._setResizeEvent(), g(document).off("focusin.bs.modal"), g(this._element).removeClass("show"), g(this._element).off("click.dismiss.bs.modal"), g(this._dialog).off("mousedown.dismiss.bs.modal"), n ? (i = m.getTransitionDurationFromElement(this._element), g(this._element).one(m.TRANSITION_END, function(t) {
            ...
            if (this._isShown && this._config.backdrop) {
                ...
                }), o && m.reflow(this._backdrop), g(this._backdrop).addClass("show"), !t)
                    return;
                if (!o)
                    return void t();
                ...
                !this._isShown && this._backdrop ? (g(this._backdrop).removeClass("show"), e = function() {
                    i._removeBackdrop(),
                    t && t()
            ...
            }), n = document.body.style.paddingRight, i = g(document.body).css("padding-right"), g(document.body).data("padding-right", n).css("padding-right", parseFloat(i) + this._scrollbarWidth + "px")),
    ...
    function Y(t, s, e) {
        ...
        if (e && "function" == typeof e)
            return e(t);
        for (var n = (new window.DOMParser).parseFromString(t, "text/html"), r = Object.keys(s), a = [].slice.call(n.body.querySelectorAll("*")), i = 0, o = a.length; i < o; i++)
            !function(t) {
                var e = a[t],
                ...
                i.forEach(function(t) {
                    !function(t, e) {
                        ...
                        if (-1 !== e.indexOf(n))
                            return -1 === z.indexOf(n) || Boolean(t.nodeValue.match(K) || t.nodeValue.match(X));
    ...
    var $,
        ...
        st = (($ = rt.prototype).enable = function() {
            ...
            this.config.selector ? this.config = r(r({}, this.config), {}, {
                trigger: "manual",
                selector: ""
            }) : this._fixTitle()
        }, $._fixTitle = function() {
            ...
            g(e.getTipElement()).hasClass("show") || "show" === e._hoverState ? e._hoverState = "show" : (clearTimeout(e._timeout), e._hoverState = "show", e.config.delay && e.config.delay.show ? e._timeout = setTimeout(function() {
    ...
    var Et,
        ...
        Tt = ((Et = Ct.prototype).show = function() {
            ...
            this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && g(this._element).hasClass("active") || g(this._element).hasClass("disabled") || (e = g(this._element).closest(".nav, .list-group")[0], n = m.getSelectorFromElement(this._element), e && (i = "UL" === e.nodeName || "OL" === e.nodeName ? "> li > .active" : ".active", o = (o = g.makeArray(g(e).find(i)))[o.length - 1]), s = g.Event("hide.bs.tab", {
                ...
                g(o).trigger(t),
                g(l._element).trigger(e)
            }, t ? this._activate(t, t.parentNode, a) : a()))
        }, Et.dispose = function() {
            g.removeData(this._element, "bs.tab"),
            this._element = null
            ...
            var i,
                o,
                s;
            e && (g(e).removeClass("active"), (i = g(e.parentNode).find("> .dropdown-menu .active")[0]) && g(i).removeClass("active"), "tab" === e.getAttribute("role") && e.setAttribute("aria-selected", !1)),
            g(t).addClass("active"),
            "tab" === t.getAttribute("role") && t.setAttribute("aria-selected", !0),
            m.reflow(t),
            t.classList.contains("fade") && t.classList.add("show"),
            t.parentNode && g(t.parentNode).hasClass("dropdown-menu") && ((o = g(t).closest(".dropdown")[0]) && (s = [].slice.call(o.querySelectorAll(".dropdown-toggle")), g(s).addClass("active")), t.setAttribute("aria-expanded", !0)),
            n && n()
    ...
    g(document).on("click.bs.tab.data-api", '[data-toggle="tab"], [data-toggle="pill"], [data-toggle="list"]', function(t) {
        t.preventDefault(),
        Tt._jQueryInterface.call(g(this), "show")
    }),
    ...
    var St,
        ...
        At = ((St = It.prototype).show = function() {
            ...
            i.isDefaultPrevented() || (this._config.animation && this._element.classList.add("fade"), t = function() {
            ...
            this._config.animation ? (e = m.getTransitionDurationFromElement(this._element), g(this._element).one(m.TRANSITION_END, t).emulateTransitionEnd(e)) : t()
