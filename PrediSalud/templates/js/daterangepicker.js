    ...
    function i(t, e, a) {
        ...
        if (this.parentEl = "body", this.element = R(t), this.startDate = j().startOf("day"), this.endDate = j().endOf("day"), this.minDate = !1, this.maxDate = !1, this.maxSpan = !1, this.autoApply = !1, this.singleDatePicker = !1, this.showDropdowns = !1, this.minYear = j().subtract(100, "year").format("YYYY"), this.maxYear = j().add(100, "year").format("YYYY"), this.showWeekNumbers = !1, this.showISOWeekNumbers = !1, this.showCustomRangeLabel = !0, this.timePicker = !1, this.timePicker24Hour = !1, this.timePickerIncrement = 1, this.timePickerSeconds = !1, this.linkedCalendars = !0, this.autoUpdateInput = !0, this.alwaysShowCalendars = !1, this.ranges = {}, this.opens = "right", this.element.hasClass("pull-right") && (this.opens = "left"), this.drops = "down", this.element.hasClass("dropup") && (this.drops = "up"), this.buttonClasses = "btn btn-sm", this.applyButtonClasses = "btn-primary", this.cancelButtonClasses = "btn-default", this.locale = {
            ...
            for (var h = this.locale.firstDay; 0 < h;)
                ...
                h--;
        if (void 0 === e.startDate && void 0 === e.endDate && R(this.element).is(":text") && (o = i = null, 2 == (r = (n = R(this.element).val()).split(this.locale.separator)).length ? (o = j(r[0], this.locale.format), i = j(r[1], this.locale.format)) : this.singleDatePicker && "" !== n && (o = j(n, this.locale.format), i = j(n, this.locale.format)), null !== o && null !== i && (this.setStartDate(o), this.setEndDate(i))), "object" == typeof e.ranges) {
            for (s in e.ranges) {
                ...
                this.minDate && i.isBefore(this.minDate, this.timepicker ? "minute" : "day") || d && o.isAfter(d, this.timepicker ? "minute" : "day") || ((l = document.createElement("textarea")).innerHTML = s, c = l.value, this.ranges[c] = [o, i])
            }
            var m = "<ul>";
    ...
    return i.prototype = {
        ...
        renderCalendar: function(t) {
            ...
            if (this.showDropdowns) {
                for (var w = e[1][1].month(), P = e[1][1].year(), x = b && b.year() || this.maxYear, M = k && k.year() || this.minYear, I = P == M, S = P == x, B = '<select class="monthselect">', A = 0; A < 12; A++)
                    (!I || k && A >= k.month()) && (!S || b && A <= b.month()) ? B += "<option value='" + A + "'" + (A === w ? " selected='selected'" : "") + ">" + this.locale.monthNames[A] + "</option>" : B += "<option value='" + A + "'" + (A === w ? " selected='selected'" : "") + " disabled='disabled'>" + this.locale.monthNames[A] + "</option>";
                B += "</select>";
                for (var L = '<select class="yearselect">', N = M; N <= x; N++)
                    L += '<option value="' + N + '"' + (N === P ? ' selected="selected"' : "") + ">" + N + "</option>";
                Y = B + (L += "</select>")
            }
            ...
            for (y = 0; y < 6; y++) {
                ...
                for (g = 0; g < 7; g++) {
                    ...
                    for (var W = "", H = !1, f = 0; f < E.length; f++)
                        ...
                        "disabled" == E[f] && (H = !0);
                    H || (W += "available"),
                    C += '<td class="' + W.replace(/^\s+|\s+$/g, "") + '" data-title="r' + y + "c" + g + '">' + e[y][g].date() + "</td>"
                }
                C += "</tr>"
            }
            C += "</tbody>",
        ...
        renderTimePicker: function(t) {
            if ("right" != t || this.endDate) {
                ...
                "left" == t ? (a = this.startDate.clone(), i = this.minDate) : "right" == t && (a = this.endDate.clone(), i = this.startDate, "" != (s = this.container.find(".drp-calendar.right .calendar-time")).html() && (a.hour(isNaN(a.hour()) ? s.find(".hourselect option:selected").val() : a.hour()), a.minute(isNaN(a.minute()) ? s.find(".minuteselect option:selected").val() : a.minute()), a.second(isNaN(a.second()) ? s.find(".secondselect option:selected").val() : a.second()), this.timePicker24Hour || ("PM" === (n = s.find(".ampmselect option:selected").val()) && a.hour() < 12 && a.hour(a.hour() + 12), "AM" === n && 12 === a.hour() && a.hour(0))), a.isBefore(this.startDate) && (a = this.startDate.clone()), r && a.isAfter(r) && (a = r.clone())),
                ...
                for (var p, f, l = 0; l < 60; l += this.timePickerIncrement) {
                    ...
                    a.minute() != l || m ? e += m ? '<option value="' + l + '" disabled="disabled" class="disabled">' + u + "</option>" : '<option value="' + l + '">' + u + "</option>" : e += '<option value="' + l + '" selected="selected">' + u + "</option>"
                }
                if (e += "</select> ", this.timePickerSeconds) {
                    ...
                    for (l = 0; l < 60; l++) {
                        ...
                        i && d.isBefore(i) && (m = !0),
                        r && d.isAfter(r) && (m = !0),
                        a.second() != l || m ? e += m ? '<option value="' + l + '" disabled="disabled" class="disabled">' + u + "</option>" : '<option value="' + l + '">' + u + "</option>" : e += '<option value="' + l + '" selected="selected">' + u + "</option>"
                    }
                    e += "</select> "
                }
                this.timePicker24Hour || (e += '<select class="ampmselect">', f = p = "", i && a.clone().hour(12).minute(0).second(0).isBefore(i) && (p = ' disabled="disabled" class="disabled"'), r && a.clone().hour(0).minute(0).second(0).isAfter(r) && (f = ' disabled="disabled" class="disabled"'), 12 <= a.hour() ? e += '<option value="AM"' + p + '>AM</option><option value="PM" selected="selected"' + f + ">PM</option>" : e += '<option value="AM" selected="selected"' + p + '>AM</option><option value="PM"' + f + ">PM</option>", e += "</select>"),
        ...
        move: function() {
            ...
            "left" == this.opens ? r + (s = i - this.element.offset().left - this.element.outerWidth()) > R(window).width() ? this.container.css({
                top: t,
                right: "auto",
                left: 9
            }) : this.container.css({
                ...
                right: s,
                left: "auto"
            }) : "center" == this.opens ? (n = this.element.offset().left - e.left + this.element.outerWidth() / 2 - r / 2) < 0 ? this.container.css({
                top: t,
                right: "auto",
                left: 9
            }) : n + r > R(window).width() ? this.container.css({
                top: t,
                left: "auto",
                right: 0
            }) : this.container.css({
                ...
                left: n,
                right: "auto"
            }) : (n = this.element.offset().left - e.left) + r > R(window).width() ? this.container.css({
                top: t,
                left: "auto",
                right: 0
            }) : this.container.css({
        ...
        clickRange: function(t) {
            ...
            (this.chosenLabel = a) == this.locale.customRangeLabel ? this.showCalendars() : (e = this.ranges[a], this.startDate = e[0], this.endDate = e[1], this.timePicker || (this.startDate.startOf("day"), this.endDate.endOf("day")), this.alwaysShowCalendars || this.hideCalendars(), this.clickApply())
        },
        ...
        hoverDate: function(t) {
            var e,
                ...
                h,
                l;
            R(t.target).hasClass("available") && (a = (e = R(t.target).attr("data-title")).substr(1, 1), i = e.substr(3, 1), r = R(t.target).parents(".drp-calendar").hasClass("left") ? this.leftCalendar.calendar[a][i] : this.rightCalendar.calendar[a][i], o = this.leftCalendar, h = this.rightCalendar, l = this.startDate, this.endDate || this.container.find(".drp-calendar tbody td").each(function(t, e) {
                var a,
                    i,
                    s,
                    n;
                R(e).hasClass("week") || (i = (a = R(e).attr("data-title")).substr(1, 1), s = a.substr(3, 1), (n = R(e).parents(".drp-calendar").hasClass("left") ? o.calendar[i][s] : h.calendar[i][s]).isAfter(l) && n.isBefore(r) || n.isSame(r, "day") ? R(e).addClass("in-range") : R(e).removeClass("in-range"))
            }))
        },
        clickDate: function(t) {
            var e,
                ...
                o,
                h;
            R(t.target).hasClass("available") && (a = (e = R(t.target).attr("data-title")).substr(1, 1), i = e.substr(3, 1), s = R(t.target).parents(".drp-calendar").hasClass("left") ? this.leftCalendar.calendar[a][i] : this.rightCalendar.calendar[a][i], this.endDate || s.isBefore(this.startDate, "day") ? (this.timePicker && (n = parseInt(this.container.find(".left .hourselect").val(), 10), this.timePicker24Hour || ("PM" === (r = this.container.find(".left .ampmselect").val()) && n < 12 && (n += 12), "AM" === r && 12 === n && (n = 0)), o = parseInt(this.container.find(".left .minuteselect").val(), 10), isNaN(o) && (o = parseInt(this.container.find(".left .minuteselect option:last").val(), 10)), h = this.timePickerSeconds ? parseInt(this.container.find(".left .secondselect").val(), 10) : 0, s = s.clone().hour(n).minute(o).second(h)), this.endDate = null, this.setStartDate(s.clone())) : !this.endDate && s.isBefore(this.startDate) ? this.setEndDate(this.startDate.clone()) : (this.timePicker && (n = parseInt(this.container.find(".right .hourselect").val(), 10), this.timePicker24Hour || ("PM" === (r = this.container.find(".right .ampmselect").val()) && n < 12 && (n += 12), "AM" === r && 12 === n && (n = 0)), o = parseInt(this.container.find(".right .minuteselect").val(), 10), isNaN(o) && (o = parseInt(this.container.find(".right .minuteselect option:last").val(), 10)), h = this.timePickerSeconds ? parseInt(this.container.find(".right .secondselect").val(), 10) : 0, s = s.clone().hour(n).minute(o).second(h)), this.setEndDate(s.clone()), this.autoApply && (this.calculateChosenLabel(), this.clickApply())), this.singleDatePicker && (this.setEndDate(this.startDate), !this.timePicker && this.autoApply && this.clickApply()), this.updateView(), t.stopPropagation())
        },
        ...
        monthOrYearChanged: function(t) {
            ...
            e ? (this.leftCalendar.month.month(s).year(n), this.linkedCalendars && (this.rightCalendar.month = this.leftCalendar.month.clone().add(1, "month"))) : (this.rightCalendar.month.month(s).year(n), this.linkedCalendars && (this.leftCalendar.month = this.rightCalendar.month.clone().subtract(1, "month"))),
            this.updateCalendars()
        },
        timeChanged: function(t) {
            ...
            a ? ((r = this.startDate.clone()).hour(i), r.minute(s), r.second(h), this.setStartDate(r), this.singleDatePicker ? this.endDate = this.startDate.clone() : this.endDate && this.endDate.format("YYYY-MM-DD") == r.format("YYYY-MM-DD") && this.endDate.isBefore(r) && this.setEndDate(r.clone())) : this.endDate && ((o = this.endDate.clone()).hour(i), o.minute(s), o.second(h), this.setEndDate(o)),
            this.updateCalendars(),
            this.updateFormInputs(),
        ...
        elementChanged: function() {
            var t,
                e,
                a;
            this.element.is("input") && this.element.val().length && (a = e = null, 2 === (t = this.element.val().split(this.locale.separator)).length && (e = j(t[0], this.locale.format), a = j(t[1], this.locale.format)), !this.singleDatePicker && null !== e && null !== a || (a = e = j(this.element.val(), this.locale.format)), e.isValid() && a.isValid() && (this.setStartDate(e), this.setEndDate(a), this.updateView()))
        },
        keydown: function(t) {
