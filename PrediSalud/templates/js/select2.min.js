!function(n) {
    ...
    var e,
        ...
        l,
        b,
        c = (t && t.fn && t.fn.select2 && t.fn.select2.amd && (e = t.fn.select2.amd), e && e.requirejs || (e ? r = e : e = {}, m = {}, v = {}, y = {}, _ = {}, a = Object.prototype.hasOwnProperty, l = [].slice, b = /\.js$/, f = function(e, t) {
            var n,
                r,
                i = p(e),
                o = i[0],
                s = t[1];
            return e = i[1], o && (n = x(o = d(o, s))), o ? e = n && n.normalize ? n.normalize(e, (r = s, function(e) {
                return d(e, r)
            })) : d(e, s) : (o = (i = p(e = d(e, s)))[0], e = i[1], o && (n = x(o))), {
                f: o ? o + "!" + e : e,
                n: e,
                pr: o,
                p: n
            ...
            if ("undefined" == d || "function" == d) {
                ...
                s = n ? n.apply(m[e], u) : void 0,
                e && (i && i.exports !== h && i.exports !== m[e] ? m[e] = i.exports : s === h && c || (m[e] = s))
            } else
                e && (m[e] = n)
        }, n = r = s = function(e, t, n, r, i) {
            if ("string" == typeof e)
                return g[e] ? g[e](t) : x(f(e, D(t)).f);
            if (!e.splice) {
            ...
            jQuery: !0
        }, e.requirejs = n, e.require = r, e.define = i), e.define("almond", function() {}), e.define("jquery", [], function() {
            var e = t || $;
            ...
            return f.Extend(r, f.Observable), r.prototype.render = function() {
                ...
                t.on("results:select", function() {
                    var e,
                        t = l.getHighlightedResults();
                    0 !== t.length && (e = f.GetData(t[0], "data"), "true" == t.attr("aria-selected") ? l.trigger("close", {}) : l.trigger("select", {
                        data: e
                    }))
                }),
                t.on("results:previous", function() {
                    var e,
                        ...
                        s = l.$results.find("[aria-selected]"),
                        a = s.index(o);
                    a <= 0 || (e = a - 1, 0 === o.length && (e = 0), (t = s.eq(e)).trigger("mouseenter"), n = l.$results.offset().top, r = t.offset().top, i = l.$results.scrollTop() + (r - n), 0 === e ? l.$results.scrollTop(0) : r - n < 0 && l.$results.scrollTop(i))
                }),
                t.on("results:next", function() {
                    var e,
                        ...
                        n,
                        r,
                        i = l.getHighlightedResults(),
                        o = l.$results.find("[aria-selected]"),
                        s = o.index(i) + 1;
                    s >= o.length || ((e = o.eq(s)).trigger("mouseenter"), t = l.$results.offset().top + l.$results.outerHeight(!1), n = e.offset().top + e.outerHeight(!1), r = l.$results.scrollTop() + n - t, 0 === s ? l.$results.scrollTop(0) : t < n && l.$results.scrollTop(r))
                }),
                ...
                0 !== o.length && (e = this.$results.find("[aria-selected]").index(o), t = this.$results.offset().top, n = o.offset().top, r = this.$results.scrollTop() + (n - t), i = n - t, r -= 2 * o.outerHeight(!1), e <= 2 ? this.$results.scrollTop(0) : (i > this.$results.outerHeight() || i < 0) && this.$results.scrollTop(r))
            ...
            return n.Extend(i, t), i.prototype.render = function() {
                ...
                var t,
                    ...
                    r,
                    i;
                0 !== e.length ? (t = e[0], n = this.$selection.find(".select2-selection__rendered"), r = this.display(t, n), n.empty().append(r), (i = t.title || t.text) ? n.attr("title", i) : n.removeAttr("title")) : this.clear()
            }, i
            ...
            return l.Extend(n, e), n.prototype.render = function() {
                ...
                this.$selection.on("click", ".select2-selection__choice__remove", function(e) {
                    var t,
                        n;
                    r.isDisabled() || (t = i(this).parent(), n = l.GetData(t[0], "data"), r.trigger("unselect", {
                        originalEvent: e,
                        data: n
                    }))
                })
            ...
            return e.prototype.bind = function(e, t, n) {
                ...
                var n,
                    r;
                e.call(this, t),
                0 < this.$selection.find(".select2-selection__placeholder").length || 0 === t.length || (n = this.options.get("translations").get("removeAllItems"), r = i('<span class="select2-selection__clear" title="' + n() + '">&times;</span>'), a.StoreData(r[0], "data", t), this.$selection.find(".select2-selection__rendered").prepend(r))
            }, e
            ...
            return e.prototype.render = function(e) {
                ...
                this.$selection.on("keydown", ".select2-search--inline", function(e) {
                    ...
                    e.which === l.BACKSPACE && "" === r.$search.val() && 0 < (t = r.$searchContainer.prev(".select2-selection__choice")).length && (n = a.GetData(t[0], "data"), r.searchRemoveChoice(n), e.preventDefault())
                }),
                ...
                this.$selection.on("keyup.search input.search", ".select2-search--inline", function(e) {
                    var t;
                    s && "input" === e.type ? r.$selection.off("input.search input.searchcheck") : (t = e.which) != l.SHIFT && t != l.CTRL && t != l.ALT && t != l.TAB && r.handleSearch(e)
                })
            ...
            return e.prototype.bind = function(e, t, n) {
                ...
                t.on("*", function(e, t) {
                    var n;
                    -1 !== s.inArray(e, i) && (t = t || {}, n = s.Event("select2:" + e, {
                        params: t
            ...
            return a.Extend(n, e), n.prototype.current = function(e) {
                ...
                this.$element.children().each(function() {
                    var e,
                        t,
                        n = l(this);
                    (n.is("option") || n.is("optgroup")) && (e = o.item(n), null !== (t = o.matches(r, e)) && i.push(t))
                }),
                e({
                    results: i
                })
            ...
            return h.Extend(r, e), r.prototype.bind = function(e, t) {
                ...
                for (var t = this, n = this.$element.find("option"), r = n.map(function() {
                    ...
                    var s,
                        ...
                        u,
                        d,
                        p = this._normalizeItem(e[o]);
                    0 <= f.inArray(p.id, r) ? (s = n.filter(function(e) {
                        return function() {
                            return f(this).val() == e.id
                        }
                    }(p)), a = this.item(s), l = f.extend(!0, {}, p, a), c = this.option(l), s.replaceWith(c)) : (u = this.option(p), p.children && (d = this.convertToOptions(p.children), h.appendMany(u, d)), i.push(u))
                }
                return i
            }, r
            ...
            return e.prototype.query = function(e, c, u) {
                ...
                null != c.term && null == c.page ? e.call(this, c, function e(t, n) {
                    ...
                    var a,
                        l = d.createTag(c);
                    null != l && ((a = d.option(l)).attr("data-select2-tag", !0), d.addOptions([a]), d.insertTag(r, l)),
                    t.results = r,
                    u(t)
                }) : e.call(this, c, u)
            ...
            return e.prototype.bind = function(e, t, n) {
                ...
                var i = this.tokenizer(t, this.options, function(e) {
                    ...
                    }).length || ((t = r.option(n)).attr("data-select2-tag", !0), r._removeOldTags(), r.addOptions([t])),
                    r.trigger("select", {
                        data: n
                    })
                });
                ...
                for (var i = n.get("tokenSeparators") || [], o = t.term, s = 0, a = this.createTag || function(e) {
                    ...
                    var l,
                        c,
                        u = o[s];
                    -1 !== d.inArray(u, i) ? (l = o.substr(0, s), null != (c = a(d.extend({}, t, {
                        term: l
                    }))) ? (r(c), o = o.substr(s + 1) || "", s = 0) : s++) : s++
                }
                return {
                    term: o
                }
            ...
            return e.prototype.append = function(e, t) {
                ...
                var e,
                    t = n.contains(document.documentElement, this.$loadingMore[0]);
                !this.loading && t && (e = this.$results.offset().top + this.$results.outerHeight(!1), this.$loadingMore.offset().top + this.$loadingMore.outerHeight(!1) <= e + 50 && this.loadMore())
            ...
            return e.prototype.bind = function(e, t, n) {
                ...
                i.length < 1 || null != (r = o.GetData(i[0], "data")).element && r.element.selected || null == r.element && r.selected || this.trigger("select", {
                    data: r
                })
            }, e
            ...
            return n.prototype.apply = function(e) {
                var t,
                    ...
                    i,
                    o;
                null == (e = c.extend(!0, {}, this.defaults, e)).dataAdapter && (null != e.ajax ? e.dataAdapter = b : null != e.data ? e.dataAdapter = $ : e.dataAdapter = _, 0 < e.minimumInputLength && (e.dataAdapter = y.Decorate(e.dataAdapter, x)), 0 < e.maximumInputLength && (e.dataAdapter = y.Decorate(e.dataAdapter, D)), 0 < e.maximumSelectionLength && (e.dataAdapter = y.Decorate(e.dataAdapter, S)), e.tags && (e.dataAdapter = y.Decorate(e.dataAdapter, w)), null == e.tokenSeparators && null == e.tokenizer || (e.dataAdapter = y.Decorate(e.dataAdapter, A)), null != e.query && (t = u(e.amdBase + "compat/query"), e.dataAdapter = y.Decorate(e.dataAdapter, t)), null != e.initSelection && (n = u(e.amdBase + "compat/initSelection"), e.dataAdapter = y.Decorate(e.dataAdapter, n))),
                null == e.resultsAdapter && (e.resultsAdapter = d, null != e.ajax && (e.resultsAdapter = y.Decorate(e.resultsAdapter, T)), null != e.placeholder && (e.resultsAdapter = y.Decorate(e.resultsAdapter, O)), e.selectOnClose && (e.resultsAdapter = y.Decorate(e.resultsAdapter, I))),
                null == e.dropdownAdapter && (e.multiple ? e.dropdownAdapter = E : (r = y.Decorate(E, C), e.dropdownAdapter = r), 0 !== e.minimumResultsForSearch && (e.dropdownAdapter = y.Decorate(e.dropdownAdapter, L)), e.closeOnSelect && (e.dropdownAdapter = y.Decorate(e.dropdownAdapter, j)), null == e.dropdownCssClass && null == e.dropdownCss && null == e.adaptDropdownCssClass || (i = u(e.amdBase + "compat/dropdownCss"), e.dropdownAdapter = y.Decorate(e.dropdownAdapter, i)), e.dropdownAdapter = y.Decorate(e.dropdownAdapter, q)),
                null == e.selectionAdapter && (e.multiple ? e.selectionAdapter = h : e.selectionAdapter = p, null != e.placeholder && (e.selectionAdapter = y.Decorate(e.selectionAdapter, f)), e.allowClear && (e.selectionAdapter = y.Decorate(e.selectionAdapter, g)), e.multiple && (e.selectionAdapter = y.Decorate(e.selectionAdapter, m)), null == e.containerCssClass && null == e.containerCss && null == e.adaptContainerCssClass || (o = u(e.amdBase + "compat/containerCss"), e.selectionAdapter = y.Decorate(e.selectionAdapter, o)), e.selectionAdapter = y.Decorate(e.selectionAdapter, v)),
                ...
                if (c.isPlainObject(e))
                    return [e];
                for (var t, n = c.isArray(e) ? e : [e], r = [], i = 0; i < n.length; i++)
                    r.push(n[i]),
                    "string" == typeof n[i] && 0 < n[i].indexOf("-") && (t = n[i].split("-")[0], r.push(t));
                return r
            ...
            function e(e, t) {
                ...
                t && t.is("input") && (n = r(this.get("amdBase") + "compat/inputData"), this.options.dataAdapter = p.Decorate(this.options.dataAdapter, n))
            }
            return e.prototype.fromElement = function(e) {
                ...
                for (var i = 0; i < e[0].attributes.length; i++) {
                    var o,
                        ...
                        l = "data-";
                    a.substr(0, l.length) == l && (o = a.substring(l.length), s = p.GetData(e[0], o), n[o.replace(/-([a-z])/g, r)] = s)
                }
    ...
    function x(e) {
        var t;
        if (w(v, e) && (t = v[e], delete v[e], _[e] = !0, o.apply(h, t)), !w(m, e) && !w(_, e))
