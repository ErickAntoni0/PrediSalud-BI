    ...
    function t(e, c) {
        ...
        function t(e) {
            ...
            if (m(c.center.lng) && m(c.center.lng)) {
                ...
                if (null === n)
                    throw new Error("The latitude/longitude coordinates that you tried to use as your center are outside the bounds of your projection (your map).");
                o.x = n[0],
                o.y = n[1]
            }
            var r,
                a,
                i = c.scaleFactor * (u.options.element.clientWidth / d3.select(u.options.element).select("svg").attr("data-width")),
                l = {
                    x: t.x - i * o.x,
                    y: t.y - i * o.y
                },
                s = "translate(" + l.x + "," + l.y + ")" + (r = i, void 0 === a && (a = r), "scale(" + r + "," + a + ")");
            d().selectAll("svg>g").transition().duration(e).attr("transform", s),
            c.onZoomComplete.call(u, {
                translate: l,
                scale: i
            })
        }
        ...
        var n = function(e, t) {
            for (var o in e)
                "object" == typeof e[o] && t[o] ? n(e[o], t[o]) : null == t[o] && (t[o] = e[o]);
            return t
        };
        u.resize = function() {
