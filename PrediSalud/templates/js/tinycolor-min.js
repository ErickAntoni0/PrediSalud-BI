!function(u) {
    ...
    function m(t, e) {
        e = e || 6;
        for (var r = c(t).toHsv(), n = r.h, a = r.s, i = r.v, s = [], o = 1 / e; e--;)
            s.push(c({
                h: n,
                s: a,
                v: i
    ...
    c.prototype = {
        ...
        toFilter: function(t) {
            var e,
                r = "#" + s(this._r, this._g, this._b, this._a),
                n = r,
    ...
    c.fromRatio = function(t, e) {
        if ("object" == typeof t) {
            var r = {};
            for (var n in t)
                t.hasOwnProperty(n) && (r[n] = "a" === n ? t[n] : w(t[n]));
            t = r
        }
        return c(t, e)
    },
    ...
    c.mostReadable = function(t, e, r) {
        for (var n, a = null, i = 0, s = (r = r || {}).includeFallbackColors, o = r.level, f = r.size, h = 0; h < e.length; h++)
            i < (n = c.readability(t, e[h])) && (i = n, a = c(e[h]));
