...
var Emitter = function() {
    ...
    Dropzone = function() {
        function C(e, t) {
            ...
            if (n.options = C.extend({}, n.defaultOptions, o, null != t ? t : {}), n.options.forceFallback || !C.isBrowserSupported())
                return _possibleConstructorReturn(n, n.options.fallback.call(_assertThisInitialized(n)));
            if (null == n.options.url && (n.options.url = n.element.getAttribute("action")), !n.options.url)
        ...
        return _inherits(C, Emitter), _createClass(C, null, [{
                ...
                this.prototype.defaultOptions = {
                    ...
                    resize: function(e, t, n, i) {
                        ...
                        if (r.srcWidth > t || r.srcHeight > n)
                            if ("crop" === i)
                                a < o ? (r.srcHeight = e.height, r.srcWidth = r.srcHeight * a) : (r.srcWidth = e.width, r.srcHeight = r.srcWidth / a);
                            else {
                                if ("contain" !== i)
                    ...
                    complete: function(e) {
                        if (e._removeLink && (e._removeLink.innerHTML = this.options.dictRemoveFile), e.previewElement)
            ...
            value: function() {
                ...
                this.clickableElements.length && function l() {
            ...
            value: function() {
                for (var e = 0, t = ["div", "form"]; e < t.length; e++) {
                    var n,
                        i = t[e];
                    if (n = function(e) {
                        var t = !0,
                    ...
                    }(this.element.getElementsByTagName(i)))
                        return n
                }
            }
        }, {
            ...
            value: function(e) {
                if (e.dataTransfer) {
                    this.emit("drop", e);
                    for (var t, n = [], i = 0; i < e.dataTransfer.files.length; i++)
                        n[i] = e.dataTransfer.files[i];
                    n.length && ((t = e.dataTransfer.items) && t.length && null != t[0].webkitGetAsEntry ? this._addFilesFromItems(t) : this.handleFiles(n)),
                ...
                return function() {
                    ...
                    try {
                        for (var r, o = s[Symbol.iterator](); !(t = (r = o.next()).done); t = !0) {
                            var a,
                                l = r.value;
                            null != l.webkitGetAsEntry && (a = l.webkitGetAsEntry()) ? a.isFile ? e.push(u.addFile(l.getAsFile())) : a.isDirectory ? e.push(u._addFilesFromDirectory(a, a.name)) : e.push(void 0) : null == l.getAsFile || null != l.kind && "file" !== l.kind ? e.push(void 0) : e.push(u.addFile(l.getAsFile()))
                        }
                    } catch (e) {
                        n = !0,
                        i = e
                                ...
                                for (var r, o = e[Symbol.iterator](); !(t = (r = o.next()).done); t = !0) {
                                    ...
                                    a.isFile ? a.file(function(e) {
                                        if (!u.options.ignoreHiddenFiles || "." !== e.name.substring(0, 1))
                                            return e.fullPath = "".concat(s, "/").concat(e.name), u.addFile(e)
            ...
            value: function(t) {
                ...
                this.accept(t, function(e) {
                    e ? (t.accepted = !1, n._errorProcessing([t], e)) : (t.accepted = !0, n.options.autoQueue && n.enqueueFile(t)),
            ...
            key: "removeFile",
            value: function(e) {
                if (e.status === C.UPLOADING && this.cancelUpload(e), this.files = without(this.files, e), this.emit("removedfile", e), 0 === this.files.length)
            ...
            value: function(t, e, n, i, r) {
                ...
                a ? (t.dataURL = e, this.createThumbnailFromUrl(t, this.options.thumbnailWidth, this.options.thumbnailHeight, this.options.resizeMethod, this.options.fixOrientation, function(e) {
            ...
            value: function(e) {
                if (e.status === C.UPLOADING) {
                    ...
                    e.status !== C.ADDED && e.status !== C.QUEUED || (e.status = C.CANCELED, this.emit("canceled", e), this.options.uploadMultiple && this.emit("canceledmultiple", [e]));
            ...
            value: function(s) {
                ...
                this._transformFiles(s, function(e) {
                    ...
                    if (u.options.chunking && (t = e[0], s[0].upload.chunked = u.options.chunking && (u.options.forceChunking || t.size > u.options.chunkSize), s[0].upload.totalChunkCount = Math.ceil(t.size / u.options.chunkSize)), s[0].upload.chunked) {
                        ...
                        r.upload.chunks = [];
                        var i = function() {
                            for (var e, t, n, i = 0; void 0 !== r.upload.chunks[i];)
                                i++;
                            i >= r.upload.totalChunkCount || (e = i * u.options.chunkSize, t = Math.min(e + u.options.chunkSize, r.size), n = {
                                name: u._getParamName(0),
                                data: o.webkitSlice ? o.webkitSlice(e, t) : o.slice(e, t),
            ...
            value: function(t, e) {
                ...
                if (this.options.params) {
                    ...
                    for (var v in "function" == typeof m && (m = m.call(this, t, i, t[0].upload.chunked ? this._getChunk(t[0], i) : null)), m) {
                        var y = m[v];
                        f.append(v, y)
                    }
                }
            ...
            key: "_transformFiles",
            value: function(n, i) {
                for (var e = this, r = [], o = 0, t = 0; t < n.length; t++)
                    !function(t) {
                    ...
                    try {
                        for (var r, o = this.element.querySelectorAll("input, textarea, select, button")[Symbol.iterator](); !(t = (r = o.next()).done); t = !0) {
                            var a = r.value,
                                ...
                                s = (s = a.getAttribute("type")) && s.toLowerCase();
                            if (null != l)
            ...
            value: function(e, t, n) {
                ...
                if (e[0].status !== C.CANCELED && 4 === t.readyState) {
                    if ("arraybuffer" !== t.responseType && "blob" !== t.responseType && (i = t.responseText, t.getResponseHeader("content-type") && ~t.getResponseHeader("content-type").indexOf("application/json")))
                        try {
                            i = JSON.parse(i)
                        } catch (e) {
                            n = e,
...
Dropzone.discover = function() {
    var s,
        e;
    return document.querySelectorAll ? s = document.querySelectorAll(".dropzone") : (s = [], (e = function(l) {
        return function() {
            var e = [],
                t = !0,
                n = !1,
...
var detectVerticalSquash = function(e) {
    ...
    ExifRestore = function() {
        ...
        return _createClass(e, null, [{
            ...
            key: "slice2Segments",
            value: function(e) {
                for (var t, n, i = 0, r = []; !(255 === e[i] & 218 === e[i + 1]);) {
                    if (255 === e[i] & 216 === e[i + 1] ? i += 2 : (t = i + (256 * e[i + 2] + e[i + 3]) + 2, n = e.slice(i, t), r.push(n), i = t), i > e.length)
                        break
                }
                return r
            }
...
var contentLoaded = function(t, n) {
    function i(e) {
        if ("readystatechange" !== e.type || "complete" === o.readyState)
            return ("load" === e.type ? t : o)[s](u + e.type, i, !1), !r && (r = !0) ? n.call(t, e.type || e) : void 0
    }
    var r = !1,
        e = !0,
        o = t.document,
